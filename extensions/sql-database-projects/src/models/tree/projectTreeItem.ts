...
export class ProjectRootTreeItem extends BaseProjectTreeItem {
    ...
    constructor(project: Project) {
        super(
            vscode.Uri.parse(path.basename(project.projectFilePath, sqlprojExtension)),
    ...
    public get treeItem(): vscode.TreeItem {
        const collapsibleState = vscode.workspace.getConfiguration(DBProjectConfigurationKey)[
            CollapseProjectNodesKey
        ]
