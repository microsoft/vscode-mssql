 ...
 */
export function sortFileFolderNodes(
  ...
  if (a instanceof FolderNode && !(b instanceof FolderNode)) {
    ...
    return a.relativeProjectUri.fsPath.localeCompare(
      b.relativeProjectUri.fsPath,
    );
  }
}
...
function fsPathToProjectUri(
  ...
  if (fileSystemUri.fsPath.startsWith(projBaseDir)) {
    ...
    const parts = utils
      .getPlatformSafeFileEntryPath(fileSystemUri.fsPath)
      .split("/");
