...
export class FileProjectEntry
  extends ProjectEntry
  implements IFileProjectEntry
{
  /**
...
abstract class UserDatabaseReferenceProjectEntry extends FileProjectEntry {
  ...
  constructor(settings: IUserDatabaseReferenceSettings, uri: Uri) {
    super(
      uri,
      /* relativePath doesn't get set for database references */ "",
      EntryType.DatabaseReference,
    );
    this.suppressMissingDependenciesErrors =
...
export class DacpacReferenceProjectEntry
  extends UserDatabaseReferenceProjectEntry
  implements IDatabaseReferenceProjectEntry
{
  ...
  public get referenceName(): string {
    return path.parse(utils.getPlatformSafeFileEntryPath(this.fsUri.fsPath))
      .name;
  }
...
export class SystemDatabaseReferenceProjectEntry
  extends FileProjectEntry
  implements IDatabaseReferenceProjectEntry
{
  constructor(
    public referenceName: string,
    public databaseVariableLiteralValue: string | undefined,
...
export class SqlProjectReferenceProjectEntry
  extends UserDatabaseReferenceProjectEntry
  implements IDatabaseReferenceProjectEntry
{
...
export class NugetPackageReferenceProjectEntry
  extends UserDatabaseReferenceProjectEntry
  implements IDatabaseReferenceProjectEntry
{
  packageName: string;
