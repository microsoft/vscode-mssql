...
export default class MainController implements vscode.Disposable {
    ...
    public async activate(): Promise<SqlDatabaseProjectProvider> {
        ...
        const oldNetCoreInstallSetting =
            vscode.workspace.getConfiguration(DBProjectConfigurationKey)[NetCoreInstallLocationKey];
        if (
            oldNetCoreInstallSetting &&
            !vscode.workspace.getConfiguration(DBProjectConfigurationKey)[DotnetInstallLocationKey]
        ) {
    ...
    private async initializeDatabaseProjects(): Promise<void> {
            ...
            vscode.commands.registerCommand(
                ...
                async (node: WorkspaceTreeItem) => {
                    return vscode.window.showErrorMessage(
                        `Properties not yet implemented: ${node.element.uri.path}`,
                    );
                },
            ),
        ); // TODO
        ...
        this.context.subscriptions.push(
            vscode.commands.registerCommand(
                ...
                async (node: WorkspaceTreeItem) => {
                    return this.projectsController.addItemPromptFromNode(node, ItemType.script);
                },
            ),
        );
        this.context.subscriptions.push(
            vscode.commands.registerCommand(
                ...
                async (node: WorkspaceTreeItem) => {
                    return this.projectsController.addItemPromptFromNode(
                        node,
        ...
        this.context.subscriptions.push(
            vscode.commands.registerCommand(
                ...
                async (node: WorkspaceTreeItem) => {
                    return this.projectsController.addItemPromptFromNode(node, ItemType.table);
                },
            ),
        );
        this.context.subscriptions.push(
            vscode.commands.registerCommand(
                ...
                async (node: WorkspaceTreeItem) => {
                    return this.projectsController.addItemPromptFromNode(node, ItemType.view);
                },
            ),
        );
        this.context.subscriptions.push(
        ...
        await templates.loadTemplates(
            path.join(this.context.extensionPath, "resources", "templates"),
        );
    }
