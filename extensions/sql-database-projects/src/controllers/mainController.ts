...
export default class MainController implements vscode.Disposable {
  ...
  private _outputChannel: vscode.OutputChannel =
    vscode.window.createOutputChannel(constants.projectsOutputChannel);
  ...
  public async activate(): Promise<SqlDatabaseProjectProvider> {
    ...
    const oldNetCoreInstallSetting = vscode.workspace.getConfiguration(
      DBProjectConfigurationKey,
    )[NetCoreInstallLocationKey];
    if (
    ...
    this.context.subscriptions.push(
      vscode.commands.registerCommand(
        ...
        async (options?: GenerateProjectFromOpenApiSpecOptions) => {
          return this.projectsController.generateProjectFromOpenApiSpec(
            options,
          );
        },
      ),
    ...
    this.context.subscriptions.push(
      vscode.commands.registerCommand(
        ...
        async (fileSystemUri: vscode.Uri, node: FileNode) => {
          return this.projectsController.openFileWithWatcher(
            fileSystemUri,
            node,
          );
        },
