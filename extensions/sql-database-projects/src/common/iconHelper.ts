...
export class IconPathHelper {
  ...
  public static setExtensionContext(extensionContext: vscode.ExtensionContext) {
    ...
    IconPathHelper.colorfulSqlProject = IconPathHelper.makeIcon(
      "colorfulSqlProject",
      true,
    );
    IconPathHelper.sqlEdgeProject = IconPathHelper.makeIcon(
      "sqlEdgeProject",
      true,
    );
    ...
    IconPathHelper.referenceDatabase =
      IconPathHelper.makeIcon("reference-database");

    IconPathHelper.sqlCmdVariablesGroup =
      IconPathHelper.makeIcon("symbol-string");
    ...
    IconPathHelper.selectConnection = IconPathHelper.makeIcon(
      "selectConnection",
      true,
    );
    ...
    IconPathHelper.schemaCompare = IconPathHelper.makeIcon(
      "schemaCompare",
      true,
    );
    IconPathHelper.targetPlatform = IconPathHelper.makeIcon(
      "targetPlatform",
      true,
    );
    ...
    IconPathHelper.dashboardSqlProj = IconPathHelper.makeIcon(
      "dashboardSqlProj",
      true,
    );
  }
  ...
  private static makeIcon(name: string, sameIcon: boolean = false) {
    ...
    const toIconUri = (relativePath: string) =>
      vscode.Uri.file(
        IconPathHelper.extensionContext.asAbsolutePath(relativePath),
      );
