...
export const MicrosoftDatatoolsSchemaSqlSql =
  "Microsoft.Data.Tools.Schema.Sql.Sql";
...
export const reloadProject = l10n.t(
...
export const reservedProjectFolders = [
  "Properties",
  "SQLCMD Variables",
  "Database References",
];
...
export const revertSqlCmdVarsButtonTitle = l10n.t(
  "Revert values to project defaults",
);
...
export const chooseSqlcmdVarsToModify = l10n.t(
...
export const enterNewSqlCmdVariableName = l10n.t(
...
export const addSqlCmdVariableWithoutDefaultValue = (varName: string) =>
  l10n.t(
    "Add SQLCMD variable '{0}' to project without default value?",
    varName,
  );
...
export function OptionNotFoundWarningMessage(label: string) {
  return l10n.t(
    "label: {0} does not exist in the options value name lookup",
    label,
  );
}
...
export const selectPublishOption = l10n.t(
  "Select where to publish the project to",
);
...
export function publishToDockerContainerPreview(name: string) {
  return l10n.t(
    "Publish to new {0} local development container (Preview)",
    name,
  );
}
...
export const publishToNewAzureServer = l10n.t(
  "Publish to new Azure SQL logical server (Preview)",
);
...
export function enterPortNumber(name: string) {
  return l10n.t(
    "Enter {0} port number or press enter to use the default value",
    name,
  );
}
...
export const enterConnectionStringTemplate = l10n.t(
  "Enter connection string template",
);
...
export function selectImageTag(name: string) {
  return l10n.t(
    "Select the image tag or press enter to use the default value",
    name,
  );
}
...
export const eulaAgreementTitle = l10n.t(
...
export const publishProjectSucceed = l10n.t(
  "Database project published successfully",
);
export const publishingProjectMessage = l10n.t(
  "Publishing project in a container...",
);
export const cleaningDockerImagesMessage = l10n.t(
...
export const creatingDeploymentSettingsMessage = l10n.t(
...
export const dockerContainerNotRunningErrorMessage = l10n.t(
  "Docker container is not running",
);
export const dockerContainerFailedToRunErrorMessage = l10n.t(
...
export const checkoutOutputMessage = l10n.t(
  "Check output pane for more details",
);
...
export function retrySucceedMessage(name: string, result: string) {
  return l10n.t(
    "Operation '{0}' completed successfully. Result: {1}",
    name,
    result,
  );
}
...
export function retryMessage(name: string, error: string) {
  return l10n.t(
    "Operation '{0}' failed. Re-trying... Error: '{1}' ",
    name,
    error,
  );
}
...
export const referenceRadioButtonsGroupTitle = l10n.t(
  "Referenced Database Type",
);
...
export const differentDbDifferentServer = l10n.t(
...
export const enterSystemDbName = l10n.t(
...
export const excludeFolderNotSupported = l10n.t(
  "Excluding folders is not yet supported",
);
...
export const createProjectFromDatabaseDialogName = l10n.t(
...
export const projectLocationPlaceholderText = l10n.t(
...
export const includePermissionsInProject = l10n.t(
  "Include permissions in project",
);
...
export const ProjectParentDirectoryNotExistError = (
  location: string,
): string => {
  return l10n.t(
...
export const updateProjectFromDatabaseDialogName = l10n.t(
...
export const compareActionRadioButtonLabel = l10n.t(
  "View changes in Schema Compare",
);
...
export const equalComparison = l10n.t(
  "The project is already up to date with the database.",
);
...
export function updatingProjectFromDatabase(
  projectName: string,
  databaseName: string,
): string {
...
export const invalidSqlConnectionString = l10n.t(
...
export const invalidDatabaseReference = l10n.t(
...
export const parentTreeItemUnknown = l10n.t(
...
export function errorFindingBuildFilesLocation(err: any) {
  return l10n.t(
    "Error finding build files location: {0}",
...
export function unableToPerformAction(
  action: string,
  uri: string,
  error?: string,
) {
  return l10n.t(
    "Unable to locate '{0}' target: '{1}'. {2}",
    action,
    uri,
    error,
  );
...
export function invalidTargetPlatform(
...
export function errorReadingProject(
  section: string,
  path: string,
  error?: string,
) {
  return l10n.t(
    "Error trying to read {0} of project '{1}'. {2}",
    section,
    path,
    error,
  );
}
export function errorAddingDatabaseReference(
  referenceName: string,
  error: string,
) {
  return l10n.t(
    "Error adding database reference to {0}. Error: {1}",
    referenceName,
    error,
  );
}
...
export const externalStreamingJobFriendlyName = l10n.t(
...
export function NetCoreSupportedVersionInstallationConfirmation(
...
export const SuppressMissingDependenciesErrors =
...
export const ProjectReferenceNameElement = l10n.t(
  "Project reference name element",
);
...
export const nodeButNotAutorestFound = l10n.t(
  "Autorest tool not found in system path, but found Node.js.  Prompting user for how to proceed.  Execute 'npm install autorest -g' to install permanently and avoid this message.",
);
export const nodeNotFound = l10n.t(
  "Neither Autorest nor Node.js (npx) found in system path.  Please install Node.js for Autorest generation to work.",
);
export const nodeButNotAutorestFoundPrompt = l10n.t(
  "Autorest is not installed. To proceed, choose whether to run Autorest from a temporary location via 'npx' or install Autorest globally then run.",
);
export const userSelectionInstallGlobally = l10n.t(
  "User selected to install autorest gloablly.  Installing now...",
);
export const userSelectionRunNpx = l10n.t("User selected to run via npx.");
export const userSelectionCancelled = l10n.t(
  "User has cancelled selection for how to run autorest.",
);
...
export function generatingProjectFailed(errorMessage: string) {
  return l10n.t(
    "Generating project via AutoRest failed.  Check output pane for more details. Error: {0}",
    errorMessage,
  );
}
export const noSqlFilesGenerated = l10n.t(
  "No .sql files were generated by Autorest. Please confirm that your spec contains model definitions, or check the output log for details.",
);
export function multipleMostDeploymentScripts(count: number) {
  return l10n.t(
    "Unexpected number of {0} files: {1}",
    autorestPostDeploymentScriptName,
    count,
  );
}
export const specSelectionText = l10n.t("OpenAPI/Swagger spec");
export const autorestProjectName = l10n.t("New SQL project name");
export function generatingProjectFromAutorest(specName: string) {
  return l10n.t(
    "Generating new SQL project from {0}...  Check output window for details.",
    specName,
  );
}
//#endregion
...
export function differentDbDifferentServerExampleUsage(
  server: string,
  db: string,
) {
...
export const targetPlatformToVersion: Map<string, string> = new Map<
  string,
  string
>([
...
export const onPremServerVersionToTargetPlatform: Map<
  number,
  SqlTargetPlatform
> = new Map<number, SqlTargetPlatform>([
...
//#region move
export const onlyMoveFilesFoldersSupported = l10n.t(
...
export function errorMovingFile(
  source: string,
  destination: string,
  error: string,
) {
...
export function errorRenamingFile(
  source: string,
  destination: string,
  error: string,
) {
