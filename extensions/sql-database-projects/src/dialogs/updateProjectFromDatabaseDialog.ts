...
export class UpdateProjectFromDatabaseDialog {
    ...
    constructor(
        connection: azdata.IConnectionProfile | mssqlVscode.IConnectionInfo | undefined,
    ...
    public async openDialog(): Promise<void> {
        ...
        this.toDispose.push(
            this.dialog.okButton.onClick(async () => await this.handleUpdateButtonClick()),
        );
    ...
    private createDatabaseRow(view: azdata.ModelView): azdata.FlexContainer {
        ...
        const databaseRow = view.modelBuilder
            .flexContainer()
            .withItems([databaseLabel, <azdata.DropDownComponent>this.databaseDropdown!], {
                flex: "0 0 auto",
    ...
    protected async populateDatabaseDropdown() {
        const connectionProfile = (this.serverDropdown!.value as ConnectionDropdownValue)
            .connection;
    ...
    private createFolderStructureRow(view: azdata.ModelView): azdata.FlexContainer {
        ...
        const folderStructureRow = view.modelBuilder
            .flexContainer()
            .withItems(
                [folderStructureLabel, <azdata.DropDownComponent>this.folderStructureDropDown],
                {
                    flex: "0 0 auto",
                    CSSStyles: { "margin-right": "10px", "margin-bottom": "-10px" },
                },
    ...
    public async handleUpdateButtonClick(): Promise<void> {
        ...
        let connection = (await getAzdataApi()!.connection.getConnections(true)).filter(
