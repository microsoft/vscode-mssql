...
import store, {
  QueryResultSingletonStore,
} from "../../src/queryResult/singletonStore";
...
suite("QueryResultSingletonStore", () => {
  ...
  test("deleteUriState should remove all data associated with a URI", () => {
    ...
    const gridId1 = "grid1";
    const gridId2 = "grid2";
    const gridKey1 = QueryResultSingletonStore.generateGridKey(
      testUri,
      gridId1,
    );
    const gridKey2 = QueryResultSingletonStore.generateGridKey(
      testUri,
      gridId2,
    );
