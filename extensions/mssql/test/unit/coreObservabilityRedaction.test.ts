...
/**
 * Redaction hard rules for the core diagnostics substrate. These are
...
import { CapturePolicy } from "../../src/sharedInterfaces/diagnostics";

suite("Core diagnostics redaction hard rules", () => {
