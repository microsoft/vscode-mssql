...
import { ItemType } from "../../../src/databaseProjects/sqldbproj";
import { getMicrosoftBuildSqlVersion } from "../../../src/databaseProjects/tools/netcoreTool";
...
suite("Templates", function (): void {
    ...
    test("newSdkSqlProjectTemplate should have @@MICROSOFT_BUILD_SQL_VERSION@@ macro fully expanded", async function (): Promise<void> {
        const configuredVersion = getMicrosoftBuildSqlVersion();
