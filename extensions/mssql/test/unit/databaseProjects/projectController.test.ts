...
import * as templates from "../../../src/databaseProjects/templates/templates";
import * as testUtils from "./testUtils";
import * as constants from "../../../src/databaseProjects/common/constants";
import { ExtractTarget } from "../../../src/databaseProjects/common/enums";
import * as utils from "../../../src/databaseProjects/common/utils";

import * as createProjectFromDatabaseQuickpick from "../../../src/databaseProjects/dialogs/createProjectFromDatabaseQuickpick";
import { SqlDatabaseProjectTreeViewProvider } from "../../../src/databaseProjects/controllers/databaseProjectTreeViewProvider";
import { ProjectsController } from "../../../src/databaseProjects/controllers/projectController";
import { NetCoreTool } from "../../../src/databaseProjects/tools/netcoreTool";
...
suite("ProjectsController", function (): void {
    ...
    suite("Add database reference", function (): void {
        test("Should not allow adding circular project references", async function (): Promise<void> {
            const projPath1 = await testUtils.createTestFile(
                this.test,
                baselines.openProjectFileBaseline,
                "SourceProject.sqlproj",
            );
            ...
            sandbox.stub(utils, "getDataWorkspaceExtensionApi").returns(dataWorkspaceMock as any);

            project1.databaseReferences.push(
                new SqlProjectReferenceProjectEntry({
                    projectGuid: project2.projectGuid,
                    projectName: project2.projectFileName,
                    projectRelativePath: vscode.Uri.file(project2.projectFilePath),
                    suppressMissingDependenciesErrors: false,
                }),
            );
            sandbox
                .stub(Project, "openProject")
                .withArgs(project1.projectFilePath)
                .resolves(project1);
