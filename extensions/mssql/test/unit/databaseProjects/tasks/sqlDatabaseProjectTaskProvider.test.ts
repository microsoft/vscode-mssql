...
import { SqlDatabaseProjectTaskProvider } from "../../../../src/databaseProjects/tasks/sqlDatabaseProjectTaskProvider";
...
suite("Sql Database Projects Task Provider", function (): void {
    ...
    function stubProjectOpenWithStyle(projectStyle: vscodeMssql.ProjectType) {
        ...
        const projectModule = require("../../../../src/databaseProjects/models/project");
