...
suite("presentationResolver", () => {
    ...
    test("developer evidence contracts have implemented default presentations", () => {
        ...
        expect(compatibleViews("deploymentPreview/1")).to.deep.equal(["diff", "log-view", "json"]);
        ...
        expect(expectedContractFor("activity", "schema.compare.export")).to.equal(
        ...
        expect(expectedContractFor("activity", "performance.dmv.snapshot")).to.equal(
