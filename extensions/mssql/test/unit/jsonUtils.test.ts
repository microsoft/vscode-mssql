...
suite("isJsonCell Tests", () => {
  suite("Valid JSON objects", () => {
    ...
    test("Should return true for valid object with properties", () => {
      ...
      expect(isJson(value), "Object with properties should be valid JSON").toBe(
        true,
      );
    });
    ...
    test("Should return true for object with array values", () => {
      ...
      expect(isJson(value), "Object with arrays should be valid JSON").toBe(
        true,
      );
    });
    ...
    test("Should return true for object with whitespace", () => {
      ...
      expect(isJson(value), "Object with whitespace should be valid JSON").toBe(
        true,
      );
    });
    ...
    test("Should return true for object with newlines", () => {
      ...
      expect(isJson(value), "Object with newlines should be valid JSON").toBe(
        true,
      );
    });
  });
  ...
  suite("Valid JSON arrays", () => {
    ...
    test("Should return true for array with objects", () => {
      ...
      expect(isJson(value), "Array with objects should be valid JSON").toBe(
        true,
      );
    });
    ...
    test("Should return true for array with whitespace", () => {
      const value = "  [1, 2, 3]  ";
      expect(isJson(value), "Array with whitespace should be valid JSON").toBe(
        true,
      );
    });
  });
  ...
  suite("Invalid JSON strings", () => {
    test("Should return false for invalid object syntax", () => {
      ...
      expect(isJson(value), "Invalid object syntax should return false").toBe(
        false,
      );
    });
    ...
    test("Should return false for array-like string that isn't valid JSON", () => {
      const value = "[this, is, not, json]";
      expect(isJson(value), "Array-like invalid JSON should return false").toBe(
        false,
      );
    });
  });
