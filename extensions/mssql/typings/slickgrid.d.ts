...
declare namespace Slick {
  ...
  export class EventHandler {
    ...
    public subscribe<T>(
      event: Event<T>,
      handler: (event: DOMEvent, args: T) => void,
    ): EventHandler;
  ...
  export class Grid<T extends SlickData> {
    ...
    public onAfterKeyboardNavigation: Slick.Event<
      OnAfterKeyboardNavigationEventArgs<T>
    >;
    // #endregion Events
  ...
  export interface OnBeforeAppendCellArgs<T extends SlickData>
    extends GridEventArgs<T> {
    row: number;
    cell: number;
  }
  ...
  export interface OnRenderedEventArgs<T extends SlickData>
    extends GridEventArgs<T> {
    startRow: number;
    endRow: number;
  }

  export interface OnAfterKeyboardNavigationEventArgs<T extends SlickData>
    extends GridEventArgs<T> {}
  ...
  export interface Formatter<T extends SlickData> {
    (
      ...
      columnDef: Column<T>,
      dataContext: T,
    ): string | undefined | { text: string; addClasses: string };
  }
