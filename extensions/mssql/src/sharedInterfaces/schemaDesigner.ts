...
export namespace SchemaDesigner {
  ...
  export interface ISchemaDesignerService {
    ...
    ): Thenable<GetDefinitionResponse>;
  ...
  export namespace OpenInEditorNotification {
    export const type = new NotificationType<OpenInEditorOptions>(
      "openInEditor",
    );
  }

  export namespace CopyToClipboardNotification {
    export const type = new NotificationType<OpenInEditorParams>(
      "copyToClipboard",
    );
  }
