...
export namespace SchemaDesigner {
    ...
    /**
     * Name-first references used by LM tool + bulk edits.
     * IDs are optional and must not be required by callers.
     */
    ...
    /**
     * Column payload used for creation via bulk edits.
     * Mirrors the editable fields in the UI; IDs are generated by the designer.
     */
    export type ColumnCreate = Partial<
        Omit<Column, "id"> & {
            name: string;
            dataType: string;
        }
    ...
    export interface ApplyEditsWebviewResponse {
        success: boolean;
        message?: string;
        reason?:
            | "not_found"
        ...
        appliedEdits?: number;
        /**
         * Full schema (internal) used by the extension host to compute version receipts.
         * This must never be surfaced in LM tool responses.
         */
        schema?: Schema;
    }

    export namespace ApplyEditsWebviewRequest {
        export const type = new RequestType<
            ApplyEditsWebviewParams,
