...
const COMPATIBILITY: Record<string, ViewKind[]> = {
    ...
    "gitChangeSet/1": ["grid", "json"],
    "efProjectDiscovery/1": ["grid", "json"],
    "efRelationalModel/1": ["grid", "json"],
    "efModelDiff/1": ["grid", "json"],
    "migrationRisk/1": ["grid", "json"],
    "migrationManifest/1": ["grid", "json"],
    "migrationExecution/1": ["scalar-cards", "json"],
    "migrationConvergence/1": ["grid", "json"],
    ...
    "workloadArtifact/1": ["scalar-cards", "json"],
    "workloadResults/1": ["grid", "bar", "json"],
    "xeventSessionLease/1": ["scalar-cards", "json"],
    "xeventCapture/1": ["scalar-cards", "json"],
    "captureIntegrity/1": ["scalar-cards", "json"],
    "xelArtifact/1": ["scalar-cards", "json"],
    "xeventAnalysis/1": ["grid", "timeseries", "bar", "json"],
    "performanceMetrics/1": ["grid", "bar", "json"],
    "performanceSnapshot/1": ["grid", "bar", "json"],
    "performanceDelta/1": ["grid", "bar", "json"],
    "databaseSchemaFingerprint/1": ["scalar-cards", "grid", "json"],
    ...
    "schemaCompareDocument/1": ["diff", "json"],
    "databaseSchemaGraph/1": ["er-diagram", "json"],
...
export const ACTIVITY_OUTPUT_CONTRACTS: Record<string, string> = {
    ...
    "git.change-set.inspect": "gitChangeSet/1",
    "ef.project.discover": "efProjectDiscovery/1",
    "ef.relational-model.extract": "efRelationalModel/1",
    "ef.relational-model.compare": "efModelDiff/1",
    "migration.data-loss.analyze": "migrationRisk/1",
    "migration.script.generate": "migrationManifest/1",
    "migration.apply": "migrationExecution/1",
    "migration.scope.validate": "migrationConvergence/1",
    ...
    "sql.workload.generate": "workloadArtifact/1",
    ...
    "xevent.capture.reconcile": "captureIntegrity/1",
    "xevent.xel.collect": "xelArtifact/1",
    "xevent.xel.analyze": "xeventAnalysis/1",
    "workload.benchmark": "performanceMetrics/1",
    "performance.dmv.snapshot": "performanceSnapshot/1",
    "performance.dmv.delta": "performanceDelta/1",
    "database.schema.fingerprint": "databaseSchemaFingerprint/1",
    "schema.compare": "schemaDiff/1",
    "schema.compare.export": "schemaCompareDocument/1",
    "database.schema.visualize": "databaseSchemaGraph/1",
