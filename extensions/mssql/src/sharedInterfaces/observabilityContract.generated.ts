...
export const OBS_CONTRACT: Registry = {
    ...
    events: [
        ...
        },
        {
            ...
            attrsComplete: true,
            notes: "SPA-6/10: map/list render began after at least one decoded batch was accepted. tier: canvas | gpuPoints | listOnly. layer: none | worldOutline | xyzRaster; offline is false only while an online layer is active.",
        },
        {
