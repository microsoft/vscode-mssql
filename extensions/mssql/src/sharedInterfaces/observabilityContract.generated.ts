...
export const OBS_CONTRACT: Registry = {
    ...
    events: [
        ...
        {
            name: "mssql.schemaDesigner.ready",
            kind: "webviewMark",
            phase: "instant",
            feature: "schemaDesigner",
            processRoles: ["webview"],
            ...
            attrsComplete: false,
            notes: "First meaningful rendered graph in the LEGACY schema designer webview (nodes committed + one frame painted). Added for fair rendered-phase comparison with the schema visualizer (addendum §13.6/§14.2). Measurement-eligible via the harness calibrated plane only, same rule as queryStudio.resultsRendered.",
        },
        {
            name: "mssql.schemaVisualizer.open.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.schemaVisualizer.open.end",
        ...
        {
            name: "mssql.schemaVisualizer.open.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.schemaVisualizer.open.begin",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                ...
                fkCount: "structuralMetadata",
                generation: "structuralMetadata",
                freshness: "safeEnum",
                source: "safeEnum",
                validation: "safeEnum",
                error: "structuralMetadata",
            ...
            attrsComplete: false,
            notes: "Extension-host model preparation completed (metadata acquire + canonical model + projection built). Host/model-phase counterpart of schemaDesigner.init.end (DacFx session/model load). NO identifiers ride — counts and enums only.",
        },
        {
            name: "mssql.schemaVisualizer.modelReady",
            kind: "webviewMark",
            phase: "instant",
            feature: "schemaVisualizer",
            processRoles: ["webview"],
            ...
            attrsComplete: false,
            notes: "Model delivered to and accepted by the webview (pre-layout).",
        },
        {
            name: "mssql.schemaVisualizer.layout.begin",
            kind: "webviewMark",
            phase: "begin",
            pairsWith: "mssql.schemaVisualizer.layout.end",
            feature: "schemaVisualizer",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
        ...
        {
            name: "mssql.schemaVisualizer.layout.end",
            kind: "webviewMark",
            phase: "end",
            pairsWith: "mssql.schemaVisualizer.layout.begin",
            feature: "schemaVisualizer",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            attrs: {
                nodeCount: "structuralMetadata",
                edgeCount: "structuralMetadata",
                layoutMode: "safeEnum",
        ...
        {
            name: "mssql.schemaVisualizer.ready",
            kind: "webviewMark",
            phase: "instant",
            feature: "schemaVisualizer",
            processRoles: ["webview"],
            ...
            measurementEligible: true,
            attrs: {
                renderedTables: "structuralMetadata",
                renderedEdges: "structuralMetadata",
                totalTables: "structuralMetadata",
                layoutMode: "safeEnum",
                subsetMode: "safeEnum",
            },
            attrsComplete: false,
            notes: "First meaningful rendered graph: required model received, initial subset chosen, layout completed or deliberately skipped, React Flow holds the expected node/edge count, one animation frame after commit (addendum §11.5). Measurement-eligible via the harness calibrated plane only.",
        },
        {
            name: "mssql.schemaVisualizer.refresh.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.schemaVisualizer.refresh.end",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.schemaVisualizer.refresh.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.schemaVisualizer.refresh.begin",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                outcome: "safeEnum",
                fingerprintChanged: "structuralMetadata",
            },
            attrsComplete: false,
        },
        {
            name: "mssql.schemaVisualizer.driftDetected",
            kind: "marker",
            phase: "instant",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            ...
            measurementEligible: false,
            attrs: {
                dirty: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Visualizer FINGERPRINT changed (never emitted on bare generation change — addendum §6.1).",
        },
        {
            name: "mssql.schemaVisualizer.rebase.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.schemaVisualizer.rebase.end",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
        ...
        {
            name: "mssql.schemaVisualizer.rebase.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.schemaVisualizer.rebase.begin",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
            attrs: {
                outcome: "safeEnum",
                operationCount: "structuralMetadata",
                conflictCount: "structuralMetadata",
            },
            attrsComplete: false,
        },
        {
            name: "mssql.schemaVisualizer.commit.handoff.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.schemaVisualizer.commit.handoff.end",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.schemaVisualizer.commit.handoff.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.schemaVisualizer.commit.handoff.begin",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                outcome: "safeEnum",
                operationCount: "structuralMetadata",
                correlatedCount: "structuralMetadata",
                conflictCount: "structuralMetadata",
                dataLoss: "structuralMetadata",
                error: "structuralMetadata",
                reason: "safeEnum",
            },
            attrsComplete: false,
            notes: "Classic credential resolution through v1 createSession/correlation/getReport readiness (addendum §13.2). Publish is a separate pair.",
        },
        {
            name: "mssql.schemaVisualizer.publish.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.schemaVisualizer.publish.end",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.schemaVisualizer.publish.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.schemaVisualizer.publish.begin",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            ...
            attrsComplete: false,
            notes: "Confirmed publish only (valid preview token). Emitted around v1 publishSession through post-publish disposal.",
        },
        {
        ...
        },
        {
            ...
            attrs: {
                status: "safeEnum",
                pagesSent: "structuralMetadata",
                pages: "structuralMetadata",
                rows: "structuralMetadata",
                cellSlots: "structuralMetadata",
                nullCells: "structuralMetadata",
                encodedBytes: "structuralMetadata",
                eventPayloadBytes: "structuralMetadata",
                maxEventPayloadBytes: "structuralMetadata",
                readMsTotal: "structuralMetadata",
                creditWaitMsTotal: "structuralMetadata",
                encodeMsTotal: "structuralMetadata",
                rowsSerializeMsTotal: "structuralMetadata",
                utf8MeasureMsTotal: "structuralMetadata",
                nullBitmapMsTotal: "structuralMetadata",
                pageBodyBuildMsTotal: "structuralMetadata",
                eventBuildMsTotal: "structuralMetadata",
                postBuildMsTotal: "structuralMetadata",
                postMsTotal: "structuralMetadata",
                encodePrepAllocatedBytes: "structuralMetadata",
                eventBuildAllocatedBytes: "structuralMetadata",
                postBuildAllocatedBytes: "structuralMetadata",
            },
            attrsComplete: false,
        ...
        },
        {
            ...
            attrs: {
                ...
                tuningDigest: "structuralMetadata",
                tuningProfile: "safeEnum",
            },
            attrsComplete: false,
            notes: "tuningDigest/tuningProfile: resolved QueryTuning snapshot attribution (QO-1) — a salt-free hash of numeric/enum knobs, never user data.",
        },
        {
            ...
            attrs: {
                ...
                residentPageBytes: "structuralMetadata",
                memoryBytesPeak: "structuralMetadata",
        ...
        },
        {
            ...
            attrs: {
                backend: "safeEnum",
                pageRows: "structuralMetadata",
                msFromSubmit: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "Compatibility alias for the first accepted row page. New measurements use mssql.queryStudio.query.firstPage.",
        },
        {
            ...
            attrsComplete: true,
            notes: "First result page after durable RowStore acceptance; this is the provider-to-host first-page boundary, not merely driver production.",
        },
        {
        ...
        },
        {
            ...
            attrs: {},
            attrsComplete: false,
            notes: "BOOT-1: first statement of the entry module - everything before this is webview HTML + chunk fetch/parse.",
        },
        {
            name: "mssql.queryStudio.boot.reactMount",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrs: {},
            attrsComplete: false,
            notes: "BOOT-1: React root render invoked.",
        },
        {
            name: "mssql.queryStudio.boot.monacoReady",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrs: {},
            attrsComplete: false,
            notes: "BOOT-1: Monaco editor instance created and model attached.",
        },
        {
            name: "mssql.queryStudio.boot.editorInteractive",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrsComplete: false,
            notes: "BOOT-1: first paint AFTER the editor mounted - the above-the-fold moment (perfMarkAfterNextPaint).",
        },
        {
            name: "mssql.queryStudio.boot.gridChunkRequested",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrs: {},
            attrsComplete: false,
            notes: "BOOT-1/P1: idle prefetch of the grid chunk began (post-editorInteractive).",
        },
        {
            name: "mssql.queryStudio.boot.gridChunkLoaded",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            measurementEligible: true,
            attrs: {
                waitedForByRender: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "BOOT-1/P1: grid chunk resolved; waitedForByRender=true means results arrived before the chunk (placeholder was shown).",
        },
        {
            name: "mssql.queryStudio.boot.planChunkLoaded",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrs: {},
            attrsComplete: false,
            notes: "BOOT-1/P2: execution-plan chunk (azdataGraph) resolved - ONLY on plan-tab activation, never at init.",
        },
        {
            name: "mssql.queryStudio.boot.vectorChunkRequested",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrs: {},
            attrsComplete: false,
            notes: "VEC-5 (reserved): lazy Vector Workbench chunk load began - ONLY on vector-tab activation, never at init.",
        },
        {
            name: "mssql.queryStudio.boot.vectorChunkLoaded",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrsComplete: false,
            notes: "VEC-5 (reserved): Vector Workbench chunk resolved; waitedForByRender=true means the tab was activated before the chunk (placeholder was shown).",
        },
        {
            name: "mssql.queryStudio.boot.spatialChunkRequested",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrs: {},
            attrsComplete: true,
            notes: "SPA-1: lazy Spatial pane chunk load began. This mark must be absent until an eligible Spatial tab is activated.",
        },
        {
            name: "mssql.queryStudio.boot.spatialChunkLoaded",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrsComplete: true,
            notes: "SPA-1: Spatial pane chunk resolved. The renderer and decode worker remain separately lazy behind activation.",
        },
        {
            name: "mssql.queryStudio.boot.autoRunStart",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrs: {},
            attrsComplete: false,
            notes: "BOOT-1: autoRun submission dispatched (open-with-SQL scenario).",
        },
        {
            name: "mssql.queryStudio.sqlcmd.toggle",
            kind: "marker",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["extensionHost"],
            ...
            measurementEligible: false,
            attrs: {
                enabled: "structuralMetadata",
                source: "safeEnum",
            },
            attrsComplete: true,
            notes: "SQLCMD mode flipped for a document. source: user | scanPrompt | scanAuto.",
        },
        {
            name: "mssql.queryStudio.sqlcmd.run",
            kind: "marker",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["extensionHost"],
            ...
            attrs: {
                ...
                batches: "structuralMetadata",
                setvars: "structuralMetadata",
                includes: "structuralMetadata",
                connects: "structuralMetadata",
                onError: "safeEnum",
                errorCode: "safeEnum",
                preprocessMs: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "One per SQLCMD-mode run: preprocess outcome, counts only. Privacy: never SQL text, variable names/values, file paths, or server names. errorCode present only on parse failure.",
        },
        {
            name: "mssql.queryStudio.scan.run",
            kind: "marker",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["extensionHost"],
            ...
            measurementEligible: true,
            attrs: {
                rules: "structuralMetadata",
                matched: "structuralMetadata",
                sampledLines: "structuralMetadata",
                ms: "structuralMetadata",
                action: "safeEnum",
            },
            attrsComplete: true,
            notes: "Post-open scan-and-detect sweep (once per document). action: none | sqlcmdPrompt | sqlcmdAuto | sqlcmdEnabled | sqlcmdDeclined | psqlSuppress. Rule ids and counts only; never file content.",
        },
        {
        ...
        },
        {
            ...
            attrs: {
                ...
                fromSpill: "structuralMetadata",
                ms: "structuralMetadata",
                cacheHit: "structuralMetadata",
                materializedPages: "structuralMetadata",
                residentPageBytes: "structuralMetadata",
        ...
        },
        {
            ...
            measurementEligible: false,
            attrs: {
                batchIndex: "structuralMetadata",
                resultSetId: "structuralMetadata",
                rowLimit: "structuralMetadata",
                retainedRows: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Row cap reached: the result set was truncated and the query canceled (cancel-on-cap). Registered retroactively — emitted since the row-cap commit.",
        },
        {
            name: "mssql.queryStudio.rows.append",
            kind: "marker",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["extensionHost"],
        ...
        {
            name: "mssql.queryStudio.grid.window.request",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
        ...
        },
        {
            ...
            kind: "webviewMark",
            phase: "begin",
            pairsWith: "mssql.queryStudio.grid.copy.end",
            feature: "queryStudio",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            attrs: {
                resultSetId: "structuralMetadata",
                ranges: "structuralMetadata",
                resultRows: "structuralMetadata",
                resultColumns: "structuralMetadata",
                includeHeaders: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "Grid copy planning begins in the webview. Pairs with copy.end for full selection-plan, projected-fetch, TSV-build, and Clipboard API latency.",
        },
        {
            name: "mssql.queryStudio.grid.copy.end",
            kind: "webviewMark",
            phase: "end",
            pairsWith: "mssql.queryStudio.grid.copy.begin",
            feature: "queryStudio",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            attrs: {
                resultSetId: "structuralMetadata",
                outcome: "safeEnum",
                rpcRequests: "structuralMetadata",
                characters: "structuralMetadata",
                durationMs: "structuralMetadata",
                planMs: "structuralMetadata",
        ...
        },
        {
            ...
            attrs: {
                executionKind: "safeEnum",
                generationChanged: "structuralMetadata",
        ...
        },
        {
            ...
            kind: "webviewMark",
            phase: "begin",
            pairsWith: "mssql.queryStudio.tab.activation.end",
            feature: "queryStudio",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: false,
            attrs: {
                ...
                to: "safeEnum",
                source: "safeEnum",
                mountedBefore: "structuralMetadata",
                requestId: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Result-pane activation starts before state changes. Source is a bounded enum such as user, runReset, terminalError, planRun, eligibility, restore, or perf.",
        },
        {
            name: "mssql.queryStudio.tab.activation.end",
            kind: "webviewMark",
            phase: "end",
            pairsWith: "mssql.queryStudio.tab.activation.begin",
            feature: "queryStudio",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: false,
            ...
            attrsComplete: false,
            notes: "Result-pane activation settled after the next paint. Paired attributes allow tab latency and unexpected automatic focus changes to be diagnosed without recording query or schema content.",
        },
        {
            name: "mssql.queryStudio.interaction.begin",
            kind: "webviewMark",
            phase: "begin",
            pairsWith: "mssql.queryStudio.interaction.end",
            feature: "queryStudio",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: false,
        ...
        },
        {
            ...
            kind: "webviewMark",
            phase: "end",
            pairsWith: "mssql.queryStudio.interaction.begin",
            feature: "queryStudio",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: false,
            ...
            attrsComplete: false,
            notes: "The semantic interaction settled through the following paint. Select-all waits for the host selection summary; copy-all waits for bounded projected fetch, TSV assembly, and Clipboard API completion; scroll scenarios wait for their product rendering seams.",
        },
        {
            ...
            attrs: {
                checkpoint: "safeEnum",
                longTaskCount: "structuralMetadata",
                longTaskTotalMs: "structuralMetadata",
                longestTaskMs: "structuralMetadata",
                gridInstances: "structuralMetadata",
                mountedTabs: "structuralMetadata",
                domNodes: "structuralMetadata",
                usedJsHeapBytes: "structuralMetadata",
                totalJsHeapBytes: "structuralMetadata",
                jsHeapLimitBytes: "structuralMetadata",
                rafThrottled: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "Post-paint renderer checkpoint for terminal results, tab activation, and semantic interactions. Long-task counters reset per run; Chromium heap fields are omitted when performance.memory is unavailable.",
        },
        {
            name: "mssql.queryStudio.grid.instance.created",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrsComplete: false,
            notes: "A SlickGrid instance was created for a Query Studio result set. Used with disposed to detect retained-grid growth while traversing many result sets.",
        },
        {
            name: "mssql.queryStudio.grid.instance.disposed",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrsComplete: false,
            notes: "A Query Studio result grid surface unmounted. Created-minus-disposed is the renderer's live-grid count.",
        },
        {
            name: "mssql.queryStudio.grid.render.complete",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            attrsComplete: false,
            notes: "SlickGrid onRendered fired after a received window was applied. Unlike firstVisibleRowsPainted, this is the actual grid render boundary before the following paint.",
        },
        {
            name: "mssql.queryStudio.export.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.queryStudio.export.end",
            feature: "queryStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
            ...
            attrsComplete: false,
            notes: "Streaming result export (QO-8): begin at writer start, end with rows/bytes/canceled.",
        },
        {
            name: "mssql.queryStudio.export.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.queryStudio.export.begin",
            feature: "queryStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
            attrs: {
                ...
                bytes: "structuralMetadata",
                canceled: "structuralMetadata",
                streamed: "structuralMetadata",
            },
            attrsComplete: false,
        },
        {
            name: "mssql.queryStudio.textView.capped",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
            ...
            measurementEligible: false,
            attrs: {
                totalRows: "structuralMetadata",
                renderedRows: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Text view refused to materialize past textViewMaxRows (QO-8) — the cap is user-visible, never silent.",
        },
        {
            name: "mssql.queryStudio.plan.parse",
            kind: "marker",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["extensionHost"],
            ...
            measurementEligible: false,
            attrs: {
                plans: "structuralMetadata",
                cacheHit: "structuralMetadata",
                ms: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Execution-plan graph parse with digest cache (QO-8).",
        },
        {
            name: "mssql.queryStudio.messagesPrepared",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["webview"],
        ...
        {
            name: "mssql.queryStudio.messages.copy.begin",
            kind: "webviewMark",
            phase: "begin",
            pairsWith: "mssql.queryStudio.messages.copy.end",
            feature: "queryStudio",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            attrs: {
                visibleMessages: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "Messages Copy All begins in the webview and delegates bounded formatting plus clipboard write to the host without returning raw message text.",
        },
        {
            name: "mssql.queryStudio.messages.copy.end",
            kind: "webviewMark",
            phase: "end",
            pairsWith: "mssql.queryStudio.messages.copy.begin",
            feature: "queryStudio",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            ...
            attrsComplete: true,
            notes: "Messages Copy All ends with aggregate outcome, bounded formatting and host clipboard timing only; message text never appears in a marker.",
        },
        {
            ...
            attrsComplete: false,
            notes: "Messages pane painted after append (QO-2 retro-registration — emitted since the message-log memoization commit).",
        },
        {
        ...
        },
        {
            ...
            measurementEligible: false,
            attrs: {
                queryStatus: "safeEnum",
                resultSets: "structuralMetadata",
                rows: "structuralMetadata",
                pages: "structuralMetadata",
                driverEvents: "structuralMetadata",
                logicalEncodedBytes: "structuralMetadata",
                encodeMsTotal: "structuralMetadata",
                sinkWaitMsTotal: "structuralMetadata",
                pauseMsBackpressure: "structuralMetadata",
                pauseMsCpuYield: "structuralMetadata",
                yields: "structuralMetadata",
                maxSynchronousSliceMs: "structuralMetadata",
                firstMetadataMs: "structuralMetadata",
                firstPageProducedMs: "structuralMetadata",
                firstPageAcceptedMs: "structuralMetadata",
                outcomeCertainty: "safeEnum",
                errorCode: "safeEnum",
                processMemorySamples: "diagnosticMetric",
                processHeapUsedStartBytes: "diagnosticMetric",
                processHeapUsedPeakBytes: "diagnosticMetric",
                processHeapUsedFinalBytes: "diagnosticMetric",
                processExternalStartBytes: "diagnosticMetric",
                processExternalPeakBytes: "diagnosticMetric",
                processExternalFinalBytes: "diagnosticMetric",
                processRssStartBytes: "diagnosticMetric",
                processRssPeakBytes: "diagnosticMetric",
                processRssFinalBytes: "diagnosticMetric",
                processArrayBuffersAvailable: "safeEnum",
                processArrayBuffersStartBytes: "diagnosticMetric",
                processArrayBuffersPeakBytes: "diagnosticMetric",
                processArrayBuffersFinalBytes: "diagnosticMetric",
                diag: "structuralMetadata",
                durationMs: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "One privacy-safe ts-native engine aggregate per query. Forwarded to PERF_MODE traces as diagnostic-only attribution; never emitted per row or cell.",
        },
        {
            prefix: "sqlDataPlane.",
            kind: "spanFamily",
        ...
        {
            prefix: "sqlDataPlane.auth.token.",
            kind: "spanFamily",
            feature: "sqlDataPlane",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            ...
            attrs: {
                authKind: "safeEnum",
                hasAccountId: "structuralMetadata",
                hasTenantId: "structuralMetadata",
                hasAccountLabel: "structuralMetadata",
                result: "safeEnum",
                expiryBucket: "safeEnum",
                errorClass: "safeEnum",
                diag: "structuralMetadata",
                durationMs: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "Diagnostic/non-gating SQL-token acquisition. Fixed enums, presence booleans, duration, and coarse expiry buckets only. Forbidden: tokens, account/tenant IDs, labels/emails, endpoints, claims, and provider error messages.",
        },
        {
            prefix: "rpc.v2.",
            kind: "spanFamily",
        ...
        },
        {
            ...
            measurementEligible: false,
            attrs: {
                captureFeatureId: "structuralMetadata",
                captureSessionId: "structuralMetadata",
                captureEventId: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Inline-completion pipeline spans/events (completions.request span; completions.stage instants; completions.result carries reverse-link IDs). Covers BOTH surfaces (classic editor + Query Studio) via a surface attr. Prompt text, document text, and schema-context text NEVER ride these events — rich capture lives in the gated feature trace store, not the diag substrate. captureFeatureId/captureSessionId/captureEventId are OPAQUE mssql.observabilityLink/1 reverse-link ids pointing at the rich record when one exists (emitted only when rich capture was armed); they are never content.",
        },
        {
        ...
        },
        {
            ...
            attrs: {},
            attrsComplete: false,
            notes: "Shared MetadataStore spans/events (oe-docs metadata_service_oe_v2_design §13): metadataStore.prepareProfile, .acquireServer, .acquireDatabase, .acquireObjectDetails, .refresh, .disposeLease, .session.open/.close, .hydrate.server/.database/.objectDetails, .drift.detected, .cache.hit/.miss, .keyCorrectness.violation. OE-parity additions (oe-docs OE_V1_PARITY_PLAN §2.2/§2.8): .auxCatalog.hydrate (span per lazy section fetch; attrs: scope server|database, section KEY [code constant, e.g. security/logins], rowCount, durationMs, result, errorClass, singleFlightCoalesced) and .auxCatalog.refresh. Attrs: key kind, SHORT profile fingerprint, section names/keys (code constants only), readiness state, generation, counts, duration, backend kind, error class. PRIVACY: no SQL text, rows, connection strings, secrets, raw endpoints, or unclassified object/database names — database rides as source.path classification like metadata.* today; aux item NAMES (logins, users, credentials, …) are object-name-classified and NEVER ride events.",
        },
        {
        ...
        },
        {
            ...
            attrs: {},
            attrsComplete: false,
            notes: "Object Explorer v2 spans/events (oe-docs oe_view_design §14.1): objectExplorerV2.view.activate, .connection.open/.close/.lost, .serverCatalog.acquire/.refresh, .databaseCatalog.acquire/.refresh, .tree.expand/.filter/.search, .command.route/.native/.handoff, .legacyConnection.created, .unsupported, .noV1Browse.violation. OE-parity additions (oe-docs OE_V1_PARITY_PLAN §2.8): .hierarchy.resolve (event; attrs: scope, folderCount, gatedCount — registry-driven layout proof), .command.invoke (event; attrs: commandId [code constant], route native|legacyRedirect, nodeKind, result), .group.mutate (event; attrs: op create|edit|delete|moveConnection|moveGroup|dnd, result — NEVER group names). Attrs: view mode, data-plane backend kind, node kind, folder kind/id (code constants), readiness state, generation, object/filter counts, duration, result status, command route (native|handoff|hidden|unavailable), handoff level (h1|h2|h3), unsupported reason, short profile fingerprint. PRIVACY: never full node paths (path KIND only), never object names, never SQL text or endpoints. The noV1Browse.violation event is the architecture tripwire — any emission is a test failure.",
        },
        {
            prefix: "centralObservability.",
            kind: "spanFamily",
            ...
            attrs: {},
            attrsComplete: false,
            notes: "Central-store upload/readback in the product (central design §11, addendum C-13): centralObservability.preview (span; attrs: sourceKind, policyId, tables, droppedFields, digestedFields, bytesEstimate), .upload (span; attrs: batchOutcome, items, rows, waitedMs), .upload.item (span; attrs: itemKind, ordinal, rowCount), .upload.refused (event; attrs: reasonCode), .provider.query (span; attrs: viewName, rowCount, resultFlags, page), .provider.failed (event; attrs: errorClass). Attr allowlist: counts, durations, policy ids, outcome/reason enums, view names, schema/contract versions, digest PREFIXES (8 chars max). FORBIDDEN: server/database/schema/object names, paths, endpoints, connection strings, SQL text, payload content, full digests, tokens, secrets. CLI-side push/migrate telemetry is harness-log spans (centralPush.*, centralInit.*), NOT DiagEvents.",
        },
        {
            name: "mssql.central.preview.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.central.preview.end",
            feature: "centralObservability",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {},
            attrsComplete: false,
            notes: "PERF_MODE: builds the UploadPreview (projection dry-run) for a fixture session (addendum §9 budget: p95 < 1.5 s at 100k events).",
        },
        {
            name: "mssql.central.preview.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.central.preview.begin",
            feature: "centralObservability",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                events: "structuralMetadata",
                tables: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Pairs with mssql.central.preview.begin.",
        },
        {
            name: "mssql.central.upload.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.central.upload.end",
            feature: "centralObservability",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {},
            attrsComplete: false,
            notes: "PERF_MODE (mssql.perf.centralUploadRoundTrip): full begin→stage→commit of a fixture session over the SQL Data Plane to a live store; cancel only at item boundaries.",
        },
        {
            name: "mssql.central.upload.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.central.upload.begin",
            feature: "centralObservability",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                items: "structuralMetadata",
                rows: "structuralMetadata",
                outcome: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Pairs with mssql.central.upload.begin.",
        },
        {
            name: "mssql.central.provider.list.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.central.provider.list.end",
            feature: "centralObservability",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {},
            attrsComplete: false,
            notes: "PERF_MODE: one paged central runs list through the central Perf History provider (pageRows honored; addendum §9 budget p95 < 200 ms/page on the 1k-run fixture).",
        },
        {
            name: "mssql.central.provider.list.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.central.provider.list.begin",
            feature: "centralObservability",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                page: "structuralMetadata",
                rowCount: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Pairs with mssql.central.provider.list.begin.",
        },
        {
            name: "mssql.queryResults.snapshot.create.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.queryResults.snapshot.create.end",
            ...
            attrs: {},
            attrsComplete: false,
            notes: "C2D-1: snapshot creation over a retained result store. Creation is O(result-set-count); scanFree on the end marker is the standing proof.",
        },
        {
            name: "mssql.queryResults.snapshot.create.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.queryResults.snapshot.create.begin",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                resultSetCount: "structuralMetadata",
                totalRows: "structuralMetadata",
                ownerKind: "safeEnum",
                purpose: "safeEnum",
                scanFree: "safeEnum",
            ...
            attrsComplete: true,
            notes: "C2D-1. scanFree=false is a regression: creation performed row-window reads.",
        },
        {
            name: "mssql.queryResults.snapshot.acquire",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrs: {
                ownerKind: "safeEnum",
                leaseCount: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "C2D-1: a consumer acquired a snapshot lease.",
        },
        {
            name: "mssql.queryResults.snapshot.release",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrsComplete: true,
            notes: "C2D-1: a snapshot lease released; leaseCount is the remaining count.",
        },
        {
            name: "mssql.queryResults.snapshot.dispose",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrs: {
                reason: "safeEnum",
                ageMs: "diagnosticMetric",
                storeDisposed: "safeEnum",
            },
            attrsComplete: true,
            notes: "C2D-1: snapshot disposed (last lease, TTL, budget, or service shutdown); storeDisposed says whether the physical store went with it.",
        },
        {
            name: "mssql.queryResults.snapshot.retentionSweep",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrs: {
                trigger: "safeEnum",
                swept: "structuralMetadata",
                expired: "structuralMetadata",
                snapshots: "structuralMetadata",
                retainedStores: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "C2D-1: TTL/budget/cap sweep over unleased snapshots. Leased snapshots are never victims.",
        },
        {
            ...
            attrs: {
                reason: "safeEnum",
                targetBytes: "structuralMetadata",
                memoryBytesBefore: "diagnosticMetric",
            },
            attrsComplete: true,
        ...
        {
            name: "mssql.queryResults.grant.minted",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            measurementEligible: false,
            attrs: {
                operationClass: "safeEnum",
            },
            attrsComplete: true,
            notes: "C2D-5 §1.3: a value-access grant was minted after user consent. Grant ids never logged.",
        },
        {
            name: "mssql.queryResults.grant.denied",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrsComplete: true,
            notes: "C2D-5 §1.3: a value-class read was refused at the gate (missing/expired/consumed/mismatched grant).",
        },
        {
            name: "mssql.queryResults.aiTool.invoke.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.queryResults.aiTool.invoke.end",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            ...
            attrsComplete: true,
            notes: "C2D-5: mssql_query_results invocation.",
        },
        {
            name: "mssql.queryResults.aiTool.invoke.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.queryResults.aiTool.invoke.begin",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            ...
            attrsComplete: true,
            notes: "C2D-5: outcome ok | denied | <typed error code> | error. Payload contents never logged.",
        },
        {
            name: "mssql.queryResults.transform.evaluate.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.queryResults.transform.evaluate.end",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                terminalKind: "safeEnum",
                opCount: "structuralMetadata",
                specDigest: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "C2D-T: fused transform evaluation begins. Filter literals and output values NEVER ride diagnostics — spec digest only (§3.7).",
        },
        {
            name: "mssql.queryResults.transform.evaluate.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.queryResults.transform.evaluate.begin",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                ...
                opCount: "structuralMetadata",
                specDigest: "structuralMetadata",
                rowsScanned: "diagnosticMetric",
                rowsMatched: "diagnosticMetric",
                partial: "safeEnum",
                partialReason: "safeEnum",
                outputRows: "structuralMetadata",
                outputClass: "safeEnum",
                ms: "diagnosticMetric",
            },
            attrsComplete: true,
            notes: "C2D-T: EvalStats honesty — a budget-cut evaluation reports partial + reason, never a confident lie. Cancellation surfaces as partialReason=canceled.",
        },
        {
            name: "mssql.queryResults.derive.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.queryResults.derive.end",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {},
            attrsComplete: false,
            notes: "C2D-T §3.6: derived snapshot creation (row-id view, no page copies).",
        },
        {
            name: "mssql.queryResults.derive.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.queryResults.derive.begin",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                specDigest: "structuralMetadata",
                derivedRows: "structuralMetadata",
                rowsScanned: "diagnosticMetric",
                fromDerived: "safeEnum",
            },
            attrsComplete: true,
            notes: "C2D-T §3.6.",
        },
        ...
        },
        {
            ...
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.queryResults.pin.open.end",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {},
            attrsComplete: false,
            notes: "C2D-3: pinned results custom editor resolve begins.",
        },
        {
            name: "mssql.queryResults.pin.open.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.queryResults.pin.open.begin",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        },
        {
            ...
            attrsComplete: true,
            notes: "C2D-3: pinned document panel disposed.",
        },
        {
            name: "mssql.queryResults.spill.orphanSweep",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            measurementEligible: false,
            attrs: {
                dirsRemoved: "structuralMetadata",
                bytesRemoved: "diagnosticMetric",
                failures: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "C2D-1 addendum §5.4: startup reclaim of session-nonce spill dirs whose session lock is stale — crashed hosts must not leak spill.",
        },
        {
            name: "mssql.queryResults.vector.ingest",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrs: {
                phase: "safeEnum",
                totalRows: "diagnosticMetric",
                rows: "diagnosticMetric",
                dimensions: "diagnosticMetric",
                packedBytes: "diagnosticMetric",
                scannedBytes: "diagnosticMetric",
                rowsScanned: "diagnosticMetric",
                nulls: "diagnosticMetric",
                unavailable: "diagnosticMetric",
                transport: "safeEnum",
                partialReason: "safeEnum",
            },
            attrsComplete: true,
            notes: "VEC-4: vector column ingest checkpoint. phase: open | packed. transport: binary-v1 | textFallback. partialReason: timeBudget | rowBudget | byteBudget | componentBudget (only on budget-cut ingests). Counts/bytes only — never components, keys, labels, or distances.",
        },
        {
            name: "mssql.queryResults.vector.analysis.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.queryResults.vector.analysis.end",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                totalBudgetMs: "diagnosticMetric",
            },
            attrsComplete: true,
            notes: "VEC-4: vector profile analysis started (ingest + worker). Budget echoed from the resolved QueryTuning snapshot, never client-supplied.",
        },
        {
            name: "mssql.queryResults.vector.analysis.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.queryResults.vector.analysis.begin",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                ...
                rows: "diagnosticMetric",
                dimensions: "diagnosticMetric",
                findings: "diagnosticMetric",
                partialTime: "safeEnum",
                workerMs: "diagnosticMetric",
                ms: "diagnosticMetric",
            },
            attrsComplete: true,
            notes: "VEC-4: analysis finished. outcome: ok | refused | error. partialTime=true means the worker hit its time budget and reported honest partial findings. Finding COUNTS only — never finding content.",
        },
        {
            name: "mssql.queryResults.vector.analysis.cancel",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrs: {},
            attrsComplete: true,
            notes: "VEC-4: a running vector analysis worker was terminated (rerun, close, or explicit cancel) — invalidates the analysis pair, never a fabricated duration.",
        },
        {
            ...
            attrsComplete: true,
            notes: "VEC-4: one local analysis worker settled. operation: profile | projection. outcome: ok | error | cancelled. partialTime is present only for a completed worker result. Counts/timing/enums only — never components, coordinates, keys, labels, findings, or error text.",
        },
        {
            ...
            attrs: {
                outcome: "safeEnum",
                dims: "diagnosticMetric",
                ms: "diagnosticMetric",
            },
            attrsComplete: true,
            notes: "VEC-10: one consented re-embed model call finished. outcome: ok | error | refused. NEVER text, vectors, endpoints, or model output — counts/ms only.",
        },
        {
            ...
            attrs: {
                outcome: "safeEnum",
                k: "diagnosticMetric",
                exactMs: "diagnosticMetric",
                approxMs: "diagnosticMetric",
                approxIncluded: "safeEnum",
                ms: "diagnosticMetric",
            },
            attrsComplete: true,
            notes: "VEC-8: one search comparison finished (exact + optional approx). outcome: ok | error | refused. NEVER SQL text, keys, labels, or distances — counts/ms only.",
        },
        {
            name: "mssql.queryResults.vector.render.begin",
            kind: "webviewMark",
            phase: "begin",
            pairsWith: "mssql.queryResults.vector.render.firstPaint",
            feature: "queryResults",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            attrs: {},
            attrsComplete: false,
            notes: "VEC-5 (reserved): Vector Workbench pane render begins (profile summary received).",
        },
        {
            name: "mssql.queryResults.vector.render.firstPaint",
            kind: "webviewMark",
            phase: "end",
            pairsWith: "mssql.queryResults.vector.render.begin",
            feature: "queryResults",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            attrs: {},
            attrsComplete: false,
            notes: "VEC-5 (reserved): first paint of the Vector Workbench pane (double-rAF, same rule as queryStudio.resultsRendered).",
        },
        {
            name: "mssql.queryResults.spatial.prepare.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.queryResults.spatial.prepare.end",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                sourceMode: "safeEnum",
                rowBudget: "diagnosticMetric",
                payloadBudgetBytes: "diagnosticMetric",
            },
            attrsComplete: true,
            notes: "SPA-5: controller-bound spatial source preparation began. Counts and budgets only; never result identifiers, columns, labels, SRIDs, coordinates, or WKB.",
        },
        {
            name: "mssql.queryResults.spatial.prepare.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.queryResults.spatial.prepare.begin",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                outcome: "safeEnum",
                sourceRowsScanned: "diagnosticMetric",
                candidateCells: "diagnosticMetric",
            ...
            attrsComplete: true,
            notes: "SPA-5: spatial preparation reached a terminal state. outcome/partialReason are bounded enums and all other attributes are aggregate counts.",
        },
        {
            name: "mssql.queryResults.spatial.prepare.cancel",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrsComplete: true,
            notes: "SPA-5: an in-flight spatial preparation was cancelled. No handle, generation, source identity, or result value is emitted.",
        },
        {
            name: "mssql.queryResults.spatial.chunk.end",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            measurementEligible: false,
            attrs: {
                sequence: "structuralMetadata",
                sourceRowsScanned: "diagnosticMetric",
                features: "diagnosticMetric",
                payloadBytes: "diagnosticMetric",
                done: "safeEnum",
                ms: "diagnosticMetric",
            },
            attrsComplete: true,
            notes: "SPA-5: one byte-capped pull response completed. Sequence is session-local structural metadata; no source identity or feature data.",
        },
        {
            name: "mssql.queryResults.spatial.decode.begin",
            kind: "webviewMark",
            phase: "begin",
            pairsWith: "mssql.queryResults.spatial.decode.end",
            feature: "queryResults",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            ...
            attrsComplete: true,
            notes: "SPA-6: decode began for the active generation. mode: worker | mainThreadFallback.",
        },
        {
            name: "mssql.queryResults.spatial.decode.end",
            kind: "webviewMark",
            phase: "end",
            pairsWith: "mssql.queryResults.spatial.decode.begin",
            feature: "queryResults",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            attrs: {
                outcome: "safeEnum",
                features: "diagnosticMetric",
                vertices: "diagnosticMetric",
                skipped: "diagnosticMetric",
                derivedBytes: "diagnosticMetric",
                ms: "diagnosticMetric",
            },
            attrsComplete: true,
            notes: "SPA-6: WKB decode settled for one active generation. Aggregate counts only; never geometry buffers, coordinates, extents, labels, or SRIDs.",
        },
        {
            name: "mssql.queryResults.spatial.decode.cancel",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["webview"],
            ...
            attrsComplete: true,
            notes: "SPA-6: worker or cooperative fallback decode was cancelled for a bounded reason.",
        },
        {
            name: "mssql.queryResults.spatial.render.begin",
            kind: "webviewMark",
            phase: "begin",
            pairsWith: "mssql.queryResults.spatial.render.firstPaint",
            feature: "queryResults",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            ...
            attrsComplete: true,
            notes: "SPA-6/10: map/list render began after at least one decoded batch was accepted. tier: canvas | clusters | gpuPoints | listOnly. layer: none | worldOutline | xyzRaster; offline is false only while an online layer is active.",
        },
        {
            name: "mssql.queryResults.spatial.render.firstPaint",
            kind: "webviewMark",
            phase: "end",
            pairsWith: "mssql.queryResults.spatial.render.begin",
            feature: "queryResults",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            measurementEligible: true,
            ...
            attrsComplete: true,
            notes: "SPA-6: first actual renderer completion after at least one accepted feature, not component mount or a loading placeholder.",
        },
        {
            ...
            attrs: {
                ...
                skipped: "diagnosticMetric",
                partial: "safeEnum",
                longTasks: "diagnosticMetric",
                derivedBytes: "diagnosticMetric",
                ms: "diagnosticMetric",
                layer: "safeEnum",
            },
            attrsComplete: true,
            notes: "SPA-6/7: bounded preparation and rendering settled. Exact values are diagnostic metrics and contain no result-derived content.",
        },
        {
            name: "mssql.queryResults.spatial.render.cancel",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["webview"],
            ...
            attrsComplete: true,
            notes: "SPA-6: render generation was invalidated by tab leave, source change, rerun, hide, disposal, or a terminal local budget.",
        },
        {
            name: "mssql.queryResults.spatial.interaction.end",
            kind: "webviewMark",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["webview"],
            ...
            attrs: {
                action: "safeEnum",
                tier: "safeEnum",
                frames: "diagnosticMetric",
                p95FrameMs: "diagnosticMetric",
                inputDelayMs: "diagnosticMetric",
            },
            attrsComplete: true,
            notes: "SPA-7 PERF_MODE semantic probe result for pan, zoom, select, filter, or fit. Never emits coordinates, bounds, labels, or selection ordinals.",
        },
        {
            name: "mssql.queryResults.spatial.resources.released",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrs: {
                reason: "safeEnum",
                leases: "diagnosticMetric",
                sessions: "diagnosticMetric",
            },
            attrsComplete: true,
            notes: "SPA-5/8: host cleanup evidence after a spatial session terminal path. Counts must reach zero at complete disposal boundaries.",
        },
        {
            name: "mssql.queryResults.spatial.basemap.open",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            notes: "SPA-10: host basemap session open attempt. outcome: ready | consentRequired | declined | incompatible | untrusted | unavailable. layerClass: xyzRaster. Never a source id, endpoint, or host name.",
        },
        {
            name: "mssql.queryResults.spatial.basemap.tile.end",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrs: {
                ...
                outcome: "safeEnum",
                ms: "diagnosticMetric",
                bytes: "diagnosticMetric",
            },
            notes: "SPA-10: one host tile request completed. cache: memory | disk | network. outcome: ok | notFound | cancelled | unavailable. Never a tile coordinate, URL, or source identity.",
        },
        {
            name: "mssql.queryResults.spatial.basemap.close",
            kind: "marker",
            phase: "instant",
            feature: "queryResults",
            processRoles: ["extensionHost"],
            ...
            attrs: {
                reason: "safeEnum",
                tiles: "diagnosticMetric",
            },
            notes: "SPA-10: host basemap session terminal path. reason: layerChange | rerun | hidden | disposed | configChanged | expired.",
        },
        {
            name: "mssql.queryResults.spatial.basemap.layer.begin",
            kind: "webviewMark",
            feature: "queryResults",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            ...
            attrsComplete: true,
            phase: "begin",
            pairsWith: "mssql.queryResults.spatial.basemap.layer.ready",
            attrs: {
                layer: "safeEnum",
            },
            notes: "SPA-10: a selected map layer began loading (world outline asset fetch or first online tile batch). layer: worldOutline | xyzRaster.",
        },
        {
            name: "mssql.queryResults.spatial.basemap.layer.ready",
            kind: "webviewMark",
            feature: "queryResults",
            processRoles: ["webview"],
            timingClass: "epochAligned",
            ...
            attrsComplete: true,
            phase: "end",
            pairsWith: "mssql.queryResults.spatial.basemap.layer.begin",
            attrs: {
                layer: "safeEnum",
                outcome: "safeEnum",
            },
            notes: "SPA-10: the selected map layer painted (outcome ok) or reached a terminal failure (outcome unavailable). Feature rendering is never blocked by this state.",
        },
        {
            name: "mssql.dashboard.open.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.dashboard.open.end",
        ...
        {
            name: "mssql.dashboard.open.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.dashboard.open.begin",
            feature: "sqlDashboard",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.dashboard.route.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.dashboard.route.ready",
            feature: "sqlDashboard",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.dashboard.route.ready",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.dashboard.route.begin",
            feature: "sqlDashboard",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                ...
                outcome: "safeEnum",
                pageKind: "safeEnum",
                unavailableReason: "safeEnum",
                requestId: "structuralMetadata",
                sections: "diagnosticMetric",
            },
            attrsComplete: true,
        },
        {
            name: "mssql.dashboard.refresh.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.dashboard.refresh.end",
            feature: "sqlDashboard",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.dashboard.refresh.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.dashboard.refresh.begin",
            feature: "sqlDashboard",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.dashboard.collector.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.dashboard.collector.end",
            feature: "sqlDashboard",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.dashboard.collector.firstPage",
            kind: "marker",
            phase: "instant",
            feature: "sqlDashboard",
            processRoles: ["extensionHost"],
        ...
        {
            name: "mssql.dashboard.collector.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.dashboard.collector.begin",
            feature: "sqlDashboard",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.dashboard.shell.paint",
            kind: "webviewMark",
            phase: "instant",
            feature: "sqlDashboard",
            processRoles: ["webview"],
        ...
        {
            name: "mssql.dashboard.route.renderComplete",
            kind: "webviewMark",
            phase: "instant",
            feature: "sqlDashboard",
            processRoles: ["webview"],
            ...
            attrs: {
                requestId: "structuralMetadata",
                route: "safeEnum",
                tableRows: "diagnosticMetric",
                rafThrottled: "structuralMetadata",
            },
            attrsComplete: true,
        },
        {
            name: "mssql.dashboard.table.renderComplete",
            kind: "webviewMark",
            phase: "instant",
            feature: "sqlDashboard",
            processRoles: ["webview"],
    ...
    metrics: [
        ...
        },
        {
            ...
            feature: "schemaDesigner",
            derivedFrom: ["mssql.schemaDesigner.init.begin", "mssql.schemaDesigner.ready"],
        },
        {
            name: "mssql.schemaVisualizer.open",
            feature: "schemaVisualizer",
            derivedFrom: ["mssql.schemaVisualizer.open.begin", "mssql.schemaVisualizer.open.end"],
        },
        {
            name: "mssql.schemaVisualizer.open.toReady",
            feature: "schemaVisualizer",
            derivedFrom: ["mssql.schemaVisualizer.open.begin", "mssql.schemaVisualizer.ready"],
        },
        {
            name: "mssql.schemaVisualizer.layout",
            feature: "schemaVisualizer",
            derivedFrom: [
        ...
        {
            name: "mssql.schemaVisualizer.commit.handoff",
            feature: "schemaVisualizer",
            derivedFrom: [
        ...
        {
            name: "mssql.schemaVisualizer.publish",
            feature: "schemaVisualizer",
            derivedFrom: [
        ...
        },
        {
            ...
            feature: "queryStudio",
            derivedFrom: ["mssql.queryStudio.query.submit", "mssql.queryStudio.query.firstPage"],
        },
        {
        ...
        },
        {
            ...
            feature: "queryStudio",
            derivedFrom: ["mssql.queryStudio.grid.copy.begin", "mssql.queryStudio.grid.copy.end"],
        },
        {
        ...
        },
        {
            ...
            feature: "queryStudio",
            derivedFrom: [
                "mssql.queryStudio.messages.copy.begin",
                "mssql.queryStudio.messages.copy.end",
            ],
        },
        {
            name: "sqlDataPlane.tsNative.query.duration",
            feature: "sqlDataPlane",
            derivedFrom: ["sqlDataPlane.tsNative.query.terminal"],
        },
        {
        ...
        {
            name: "sqlDataPlane.tsNative.query.pages",
            feature: "sqlDataPlane",
            derivedFrom: ["sqlDataPlane.tsNative.query.terminal"],
        },
        {
        ...
        {
            name: "mssql.queryResults.snapshot.create",
            feature: "queryResults",
            derivedFrom: [
                "mssql.queryResults.snapshot.create.begin",
                "mssql.queryResults.snapshot.create.end",
            ],
        },
        {
            name: "mssql.queryResults.pin.open",
            feature: "queryResults",
            derivedFrom: ["mssql.queryResults.pin.open.begin", "mssql.queryResults.pin.open.end"],
        },
        {
        ...
        },
        {
            ...
            derivedFrom: [
                ...
                "mssql.queryStudio.boot.editorInteractive",
            ],
        },
        {
        ...
        },
        {
            ...
            derivedFrom: [
                ...
                "mssql.queryStudio.boot.spatialChunkLoaded",
            ],
        },
        {
        ...
        {
            name: "mssql.queryResults.spatial.prepare",
            feature: "queryResults",
            derivedFrom: [
                "mssql.queryResults.spatial.prepare.begin",
                "mssql.queryResults.spatial.prepare.end",
            ],
        },
        {
            name: "mssql.queryResults.spatial.decode",
            feature: "queryResults",
            derivedFrom: [
                "mssql.queryResults.spatial.decode.begin",
                "mssql.queryResults.spatial.decode.end",
            ],
        },
        {
            name: "mssql.queryResults.spatial.render.firstPaint",
        ...
        {
            name: "mssql.queryResults.spatial.basemap.layerReady",
            feature: "queryResults",
            derivedFrom: [
                "mssql.queryResults.spatial.basemap.layer.begin",
                "mssql.queryResults.spatial.basemap.layer.ready",
            ],
        },
        {
            name: "mssql.dashboard.open",
            feature: "sqlDashboard",
            derivedFrom: ["mssql.dashboard.open.begin", "mssql.dashboard.open.end"],
        },
        {
            name: "mssql.dashboard.open.toRender",
            feature: "sqlDashboard",
            derivedFrom: ["mssql.dashboard.open.begin", "mssql.dashboard.route.renderComplete"],
        },
        {
            name: "mssql.dashboard.route",
            feature: "sqlDashboard",
            derivedFrom: ["mssql.dashboard.route.begin", "mssql.dashboard.route.ready"],
        },
        {
            name: "mssql.dashboard.route.toRender",
            feature: "sqlDashboard",
            derivedFrom: ["mssql.dashboard.route.begin", "mssql.dashboard.route.renderComplete"],
        },
        {
            name: "mssql.dashboard.refresh",
            feature: "sqlDashboard",
            derivedFrom: ["mssql.dashboard.refresh.begin", "mssql.dashboard.refresh.end"],
        },
        {
            name: "mssql.dashboard.collector",
            feature: "sqlDashboard",
            derivedFrom: ["mssql.dashboard.collector.begin", "mssql.dashboard.collector.end"],
        },
    ],
    classifications: {
        secret: {
