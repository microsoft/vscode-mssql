...
export const OBS_CONTRACT: Registry = {
    ...
    events: [
        ...
        },
        {
            ...
            attrsComplete: false,
            notes: "DMV, Query Store, SQL Agent and profiler activity emitted by the sql-diagnostics package from the extension host. Spans append .begin/.end to these names.",
        },
        {
