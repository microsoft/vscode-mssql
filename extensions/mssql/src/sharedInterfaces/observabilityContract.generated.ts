...
export const OBS_CONTRACT: Registry = {
    ...
    events: [
        ...
        {
            name: "mssql.runbookStudio.open.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.open.end",
        ...
        {
            name: "mssql.runbookStudio.open.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.open.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                documentKind: "safeEnum",
                runbookRevision: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Runbook Studio document open (editor provider resolve through controller ready). documentKind: saved|untitled|fixture.",
        },
        {
            name: "mssql.runbookStudio.webview.ready",
            kind: "webviewMark",
            phase: "instant",
            feature: "runbookStudio",
            processRoles: ["webview"],
            ...
            attrs: {},
            attrsComplete: false,
            notes: "Cross-process endpoint (webview interactive after document open). Measurement-eligible via the harness's calibrated clock model ONLY; epoch-aligned/diagnostic everywhere else.",
        },
        {
            name: "mssql.runbookStudio.compile.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.compile.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.runbookStudio.compile.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.compile.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                ...
                nodeCount: "structuralMetadata",
                modelRole: "safeEnum",
                tokensIn: "structuralMetadata",
                tokensOut: "structuralMetadata",
                toolCalls: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Intent compile/validate through the runtime adapter. Official ONLY in the deterministic/fake-model lane; real-model lane is diagnostic (A2 §12.4). No intent or prompt text in attrs ever.",
        },
        {
            name: "mssql.runbookStudio.bind.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.bind.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.runbookStudio.bind.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.bind.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                parameterCount: "structuralMetadata",
                inferredCount: "structuralMetadata",
                explicitCount: "structuralMetadata",
                defaultCount: "structuralMetadata",
                validationErrors: "structuralMetadata",
                targetClass: "safeEnum",
            },
            attrsComplete: false,
            notes: "Parameter binding + validation. Counts and source-kind rollups only; parameter values never appear (identifierSensitive+ by definition). targetClass: local|sandbox|test|staging|approved-read-only-production.",
        },
        {
            name: "mssql.runbookStudio.estimate.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.estimate.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.runbookStudio.estimate.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.estimate.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            ...
            attrsComplete: false,
            notes: "Dry-run estimate over a bound plan.",
        },
        {
            name: "mssql.runbookStudio.runtime.launch.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.runtime.launch.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.runbookStudio.runtime.launch.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.runtime.launch.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                outcome: "safeEnum",
                runtimeVersion: "structuralMetadata",
                coldStart: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Supplied-runtime process launch (package validation through process live). Boundary-only observation: no runtime-internal phases are claimed (A2 §11.1).",
        },
        {
            name: "mssql.runbookStudio.runtime.initialize.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.runtime.initialize.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.runbookStudio.runtime.initialize.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.runtime.initialize.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                outcome: "safeEnum",
                protocolVersion: "structuralMetadata",
                capabilityCount: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Adapter initialize/capability probe against the launched runtime.",
        },
        {
            name: "mssql.runbookStudio.runtime.request.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.runtime.request.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
        ...
        {
            name: "mssql.runbookStudio.runtime.request.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.runtime.request.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
            ...
            attrsComplete: false,
            notes: "Generic runtime-adapter request round-trip. Diagnostic by policy (explains, does not gate) unless a method-specific metric is separately approved.",
        },
        {
            name: "mssql.runbookStudio.run.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.run.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.runbookStudio.run.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.run.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                outcome: "safeEnum",
                nodeCount: "structuralMetadata",
                activityCount: "structuralMetadata",
                gateCount: "structuralMetadata",
                cancelled: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Host-observed run lifetime (accepted through terminal). Official for the precompiled no-model lane; runs that include model calls or approval waits are diagnostic. Exactly one run.end per accepted run (one-terminal invariant).",
        },
        {
            name: "mssql.runbookStudio.run.state",
            kind: "marker",
            phase: "instant",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            ...
            attrsComplete: false,
            notes: "Run state transition (accepted|running|awaitingApproval|cancelling|succeeded|failed|cancelled). Never silently dropped.",
        },
        {
            name: "mssql.runbookStudio.run.cancel.requested",
            kind: "marker",
            phase: "instant",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            ...
            attrs: {},
            attrsComplete: false,
            notes: "User or host cancellation request.",
        },
        {
            name: "mssql.runbookStudio.run.cancel.settled",
            kind: "marker",
            phase: "instant",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            ...
            attrsComplete: false,
            notes: "Cancellation settled with outcome (cancelled|alreadyTerminal|failed). Pairs conceptually with cancel.requested but both are instants; latency is derived diagnostically.",
        },
        {
            name: "mssql.runbookStudio.run.recover.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.run.recover.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
        ...
        },
        {
            ...
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.run.recover.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
            ...
            attrsComplete: false,
            notes: "Reopen/recovery reconciliation after runtime exit or extension restart. Diagnostic until recovery semantics graduate (A2 §7.1).",
        },
        {
            name: "mssql.runbookStudio.activity.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.activity.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                activityKind: "safeEnum",
                activityVersion: "structuralMetadata",
                attempt: "structuralMetadata",
            },
            attrsComplete: false,
        },
        {
            name: "mssql.runbookStudio.activity.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.activity.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                ...
                rows: "structuralMetadata",
                bytes: "structuralMetadata",
                handleCount: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "One activity attempt (queue->terminal), host-observed. Official candidate per registered activity kind. Exactly one end per begin including cancellation/policy-denial/runtime-exit. Result payloads travel by data handle; only counts appear here.",
        },
        {
            name: "mssql.runbookStudio.activity.progress",
            kind: "marker",
            phase: "instant",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            ...
            measurementEligible: false,
            attrs: {
                dropped: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Coalescible progress tick within an activity span. May be coalesced/dropped with an explicit dropped count; never used for timing.",
        },
        {
            name: "mssql.runbookStudio.gate.requested",
            kind: "marker",
            phase: "instant",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            ...
            attrsComplete: false,
            notes: "Approval gate reached; run paused. Never dropped or coalesced.",
        },
        {
            name: "mssql.runbookStudio.gate.responded",
            kind: "marker",
            phase: "instant",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            ...
            attrsComplete: false,
            notes: "Gate response (approved|rejected|timeout|invalidated). Never dropped. Idempotent responses journal once.",
        },
        {
            name: "mssql.runbookStudio.model.request.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.model.request.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
        ...
        {
            name: "mssql.runbookStudio.model.request.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.model.request.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
            attrs: {
                modelRole: "safeEnum",
                outcome: "safeEnum",
                modelVendor: "structuralMetadata",
                modelFamily: "structuralMetadata",
                modelId: "structuralMetadata",
                tokensIn: "structuralMetadata",
                tokensOut: "structuralMetadata",
                toolCalls: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Host-brokered model request (extension-owned roles) or runtime-reported usage where supplied. Diagnostic for remote models. Prompt/response/tool content NEVER appears in attrs (providerText rule applies to any provider-message capture elsewhere).",
        },
        {
            name: "mssql.runbookStudio.output.fetch.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.output.fetch.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.runbookStudio.output.fetch.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.output.fetch.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            ...
            attrsComplete: false,
            notes: "One page/artifact fetch through a typed data handle (controller-mediated).",
        },
        {
            name: "mssql.runbookStudio.presentation.resolve.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.presentation.resolve.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.runbookStudio.presentation.resolve.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.presentation.resolve.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            attrs: {
                widgetCount: "structuralMetadata",
                sectionCount: "structuralMetadata",
                nodeCount: "structuralMetadata",
                fallbackCount: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Pure presentation resolution (PresentationDefinition + snapshot -> render model). Same-process official candidate; zero model calls by contract.",
        },
        {
            name: "mssql.runbookStudio.presentation.patch.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.presentation.patch.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
        ...
        {
            name: "mssql.runbookStudio.presentation.patch.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.presentation.patch.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: true,
            ...
            attrsComplete: false,
            notes: "Presentation patch validate+apply (direct edit or chat-authored). Atomic against a base revision.",
        },
        {
            name: "mssql.runbookStudio.plan.renderComplete",
            kind: "webviewMark",
            phase: "instant",
            feature: "runbookStudio",
            processRoles: ["webview"],
            ...
            attrsComplete: false,
            notes: "Plan graph painted. Calibrated cross-process metric only (same rules as mssql.resultsGrid.renderComplete).",
        },
        {
            name: "mssql.runbookStudio.results.firstUsefulRender",
            kind: "webviewMark",
            phase: "instant",
            feature: "runbookStudio",
            processRoles: ["webview"],
            ...
            attrsComplete: false,
            notes: "First useful results dashboard paint for a run/open trace. Calibrated cross-process metric only.",
        },
        {
            name: "mssql.runbookStudio.results.updateApplied",
            kind: "webviewMark",
            phase: "instant",
            feature: "runbookStudio",
            processRoles: ["webview"],
            ...
            attrsComplete: false,
            notes: "Incremental results update applied in the webview. Diagnostic + responsiveness metric; never a gate.",
        },
        {
            name: "mssql.runbookStudio.evidence.export.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "mssql.runbookStudio.evidence.export.end",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
        ...
        {
            name: "mssql.runbookStudio.evidence.export.end",
            kind: "marker",
            phase: "end",
            pairsWith: "mssql.runbookStudio.evidence.export.begin",
            feature: "runbookStudio",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
            attrs: {
                eventCount: "structuralMetadata",
                artifactCount: "structuralMetadata",
            },
            attrsComplete: false,
            notes: "Evidence/diagnostic export build. Content governed by A2 §9.4 exclusions.",
        },
    ],
    metrics: [
        {
        ...
        },
        {
            ...
            feature: "runbookStudio",
            derivedFrom: ["mssql.runbookStudio.open.begin", "mssql.runbookStudio.open.end"],
        },
        {
            name: "runbookStudio.bindMs",
            feature: "runbookStudio",
            derivedFrom: ["mssql.runbookStudio.bind.begin", "mssql.runbookStudio.bind.end"],
        },
        {
            name: "runbookStudio.runMs",
            feature: "runbookStudio",
            derivedFrom: ["mssql.runbookStudio.run.begin", "mssql.runbookStudio.run.end"],
        },
        {
            name: "runbookStudio.activityMs",
            feature: "runbookStudio",
            derivedFrom: ["mssql.runbookStudio.activity.begin", "mssql.runbookStudio.activity.end"],
        },
        {
            name: "runbookStudio.presentationResolveMs",
            feature: "runbookStudio",
            derivedFrom: [
                "mssql.runbookStudio.presentation.resolve.begin",
                "mssql.runbookStudio.presentation.resolve.end",
            ],
        },
    ],
    classifications: {
