...
export const OBS_CONTRACT: Registry = {
    ...
    events: [
        ...
        },
        {
            ...
            attrs: {},
            attrsComplete: true,
            notes: "Local Debug Console viewer opened; no source identifiers or captured content are attached.",
        },
        {
            ...
            attrs: {
                ...
                redactions: "structuralMetadata",
            },
            attrsComplete: true,
            notes: "A local redacted JSONL export completed; records only output event and redaction counts.",
        },
        {
