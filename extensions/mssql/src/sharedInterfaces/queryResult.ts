...
export namespace GetFiltersRequest {
  export const type = new RequestType<GetFiltersParams, ColumnFilterMap, void>(
    "getFilters",
  );
}
...
export namespace SetFiltersRequest {
  export const type = new RequestType<SetFiltersParams, void, void>(
    "setFilters",
  );
}
...
export namespace GetColumnWidthsRequest {
  export const type = new RequestType<GetColumnWidthsParams, number[], void>(
    "getColumnWidths",
  );
}
...
export namespace SetColumnWidthsRequest {
  export const type = new RequestType<SetColumnWidthsParams, void, void>(
    "setColumnWidths",
  );
}
...
export namespace CopySelectionRequest {
  export const type = new RequestType<CopySelectionRequestParams, void, void>(
    "copySelection",
  );
}
...
export namespace CopyHeadersRequest {
  export const type = new RequestType<CopyHeadersParams, void, void>(
    "copyHeaders",
  );
}
...
export namespace CopyAsCsvRequest {
  export const type = new RequestType<CopyAsCsvRequest, void, void>(
    "copyAsCsv",
  );
}
...
export namespace CopyAsJsonRequest {
  export const type = new RequestType<CopyAsJsonRequest, void, void>(
    "copyAsJson",
  );
}
...
export namespace CopyAsInClauseRequest {
  export const type = new RequestType<CopyAsInClauseRequest, void, void>(
    "copyAsInClause",
  );
}
...
export namespace CopyAsInsertIntoRequest {
  export const type = new RequestType<CopyAsInsertIntoRequest, void, void>(
    "copyAsInsertInto",
  );
}
...
export namespace SetSelectionSummaryRequest {
  export const type = new NotificationType<SetSelectionSummary>(
    "setSelectionSummary",
  );
}
...
export namespace OpenInNewTabRequest {
  export const type = new RequestType<OpenInNewTabParams, void, void>(
    "openInNewTab",
  );
}
...
export namespace SetEditorSelectionRequest {
  export const type = new RequestType<SetEditorSelectionParams, void, void>(
    "setEditorSelection",
  );
}
...
export namespace SaveResultsWebviewRequest {
  export const type = new RequestType<SaveResultsWebviewParams, void, void>(
    "saveResults",
  );
}
...
export namespace GetRowsRequest {
  export const type = new RequestType<GetRowsParams, ResultSetSubset, void>(
    "getRows",
  );
}
...
export namespace SetGridScrollPositionNotification {
  export const type = new NotificationType<SetGridScrollPositionParams>(
...
export namespace SetMaximizedGridNotification {
  export const type = new NotificationType<{ uri: string; gridId: string }>(
    "setMaximizedGrid",
  );
}
