...
export function profilerSortComparator(
    ...
    // eslint-disable-next-line no-restricted-syntax -- external data values may be null
...
export function getNextSortState(
    ...
    // eslint-disable-next-line no-restricted-syntax -- null represents absence of sort state
    return null;
}
