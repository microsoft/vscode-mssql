...
export namespace ColorThemeChangeNotification {
  export const type = new NotificationType<ColorThemeKind>(
...
export namespace ExecuteCommandRequest {
  export const type = new RequestType<ExecuteCommandParams, void, void>(
    "executeCommand",
  );
}
...
export namespace SendActionEventNotification {
  export const type = new NotificationType<WebviewTelemetryActionEvent>(
    "sendActionEvent",
  );
}
...
export namespace SendErrorEventNotification {
  export const type = new NotificationType<WebviewTelemetryErrorEvent>(
    "sendErrorEvent",
  );
}
