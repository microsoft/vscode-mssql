  ...
  implements vscode.CodeLensProvider, vscode.Disposable
{
  ...
  public provideCodeLenses(
    ...
    const connection = this._connectionManager.getConnectionInfo(
