...
>(
  (
    ...
    const [expandCollapseButtonLabel, setExpandCollapseButtonLabel] =
      useState<string>(locConstants.tableDesigner.maximizePanelSize);
    const [expandCollapseButtonIcon, setExpandCollapseButtonIcon] =
      useState<ReactElement>(<FluentIcons.ChevronUp12Filled />);
    ...
    return (
      ...
      >
        ...
        <div className={classes.tabContent}>
          ...
          {activeTab === DesignerDefinitionTabs.Issues &&
            issues &&
            issues.length > 0 && (
