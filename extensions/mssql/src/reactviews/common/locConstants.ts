...
export class LocConstants {
    ...
    public get userDialog() {
        return {
            titleCreate: l10n.t("New User"),
            titleEdit: l10n.t("User Properties"),
            descriptionCreate: (databaseName: string, serverName: string) =>
                l10n.t({
                    message: "Create a new user in '{0}' on '{1}'.",
                    args: [databaseName, serverName],
                    comment: ["{0} is the database name", "{1} is the server name"],
                }),
            descriptionEdit: (userName: string, databaseName: string, serverName: string) =>
                l10n.t({
                    message: "Edit '{0}' in '{1}' on '{2}'.",
                    args: [userName, databaseName, serverName],
                    comment: [
                        "{0} is the user name",
            ...
            loading: l10n.t("Loading..."),
            generalSection: l10n.t("General"),
            securablesTab: l10n.t("Securables"),
            ownedSchemasSection: l10n.t("Owned Schemas"),
            membershipSection: l10n.t("Membership"),
            securablesSection: l10n.t("Securables"),
            permissionsSection: l10n.t("Explicit Permissions"),
            effectivePermissionsSection: l10n.t("Effective Permissions"),
            advancedSection: l10n.t("Advanced"),
            identitySection: l10n.t("Identity"),
            schemaOwnershipSection: l10n.t("Schema Ownership"),
            schemaOwnershipDescription: l10n.t("Schemas owned by this user"),
            roleMembershipSection: l10n.t("Role Membership"),
            roleMembershipDescription: l10n.t("Member of database roles"),
            nameLabel: l10n.t("Name"),
            nameRequired: l10n.t("User name is required"),
            userTypeLabel: l10n.t("User Type"),
            defaultSchemaLabel: l10n.t("Default Schema"),
            loginLabel: l10n.t("Login"),
            passwordLabel: l10n.t("Password"),
            confirmPasswordLabel: l10n.t("Confirm Password"),
            defaultLanguageLabel: l10n.t("Default Language"),
            loginRequired: l10n.t("Login is required for this user type"),
            passwordRequired: l10n.t("Password is required"),
            passwordMismatch: l10n.t("Passwords do not match"),
            passwordInvalid: l10n.t("Password does not meet SQL password policy requirements"),
            userTypeLoginMapped: l10n.t("Login mapped"),
            userTypeWindowsUser: l10n.t("Windows user"),
            userTypeSqlAuth: l10n.t("SQL authentication"),
            userTypeAadAuth: l10n.t("Microsoft Entra authentication"),
            userTypeNoLogin: l10n.t("No login access"),
            ownedSchemasEmpty: l10n.t("No schemas available."),
            membershipEmpty: l10n.t("No database roles available."),
            securablesEmpty: l10n.t("No securables assigned."),
            effectivePermissionsEmpty: l10n.t("No effective permissions available."),
            valueUnknown: l10n.t("-"),
            schemaColumn: l10n.t("Schema"),
            objectColumn: l10n.t("Object"),
            permissionsColumn: l10n.t("Permissions"),
            databaseRoleColumn: l10n.t("Database Role"),
            searchOwnedSchemasPlaceholder: l10n.t("Search schemas"),
            searchMembershipPlaceholder: l10n.t("Search roles"),
            searchSecurablesPlaceholder: l10n.t("Search securables"),
            securableNameColumn: l10n.t("Name"),
            securableSchemaColumn: l10n.t("Schema"),
            securableTypeColumn: l10n.t("Object Type"),
            permissionColumn: l10n.t("Permission"),
            grantorColumn: l10n.t("Grantor"),
            grantColumn: l10n.t("Grant"),
            withGrantColumn: l10n.t("With Grant"),
            denyColumn: l10n.t("Deny"),
            selectColumn: l10n.t("Select"),
            explicitPermissionsEmpty: l10n.t("Select a securable to edit permissions."),
            permissionsEmptyPreview: l10n.t("No explicit permissions."),
            securablesPreviewTitle: (count: number) =>
                l10n.t({
                    message: "Securables ({0})",
                    args: [count],
                    comment: ["{0} is the number of securables"],
                }),
            addOrManageSecurables: l10n.t("+ Add or manage securables..."),
            noOwnedSchemas: l10n.t("No schemas selected."),
            schemaOwnershipSelectLabel: l10n.t("Add schema"),
            schemaOwnershipSelectPlaceholder: l10n.t("Select a schema"),
            addSchemaButton: l10n.t("Add schema"),
            addSecurableButton: l10n.t("Add..."),
            removeSecurableButton: l10n.t("Remove"),
            addSecurableTitle: l10n.t("Add Securables"),
            searchMethodLabel: l10n.t("How would you like to add objects?"),
            searchMethodSpecific: l10n.t("Specific objects"),
            searchMethodSpecificDescription: l10n.t(
                "Select individual tables, views, stored procedures, or other objects",
            ),
            searchMethodTypes: l10n.t("All objects of certain types"),
            searchMethodTypesDescription: l10n.t(
                "Include all objects of selected types (e.g., Tables, Views)",
            ),
            searchMethodSchema: l10n.t("All objects in a schema"),
            searchMethodSchemaDescription: l10n.t(
                "Include every object belonging to the selected schema",
            ),
            quickFiltersLabel: l10n.t("Quick filters"),
            searchTypesLabel: l10n.t("Object types"),
            searchSchemaLabel: l10n.t("Schema"),
            searchSchemaPlaceholder: l10n.t("Select a schema"),
            searchSchemaRequired: l10n.t("Select a schema."),
            searchTextLabel: l10n.t("Search objects by name..."),
            searchButton: l10n.t("Search"),
            searchLoading: l10n.t("Searching..."),
            searchStart: l10n.t("Start typing to see results."),
            searchNoResults: l10n.t("No search results."),
            searchFailed: l10n.t("Search failed."),
            searchTypeRequired: l10n.t("Select at least one object type."),
            addSelectedButton: l10n.t("Add"),
            securablesInfoCallout: l10n.t(
                "You can set specific permissions (GRANT, DENY, WITH GRANT) for each securable after adding them.",
            ),
            selectedCount: (count: number) =>
                l10n.t({
                    message: "{0} selected",
                    args: [count],
                    comment: ["{0} is the number of selected items"],
                }),
            resultsCount: (count: number) =>
                l10n.t({
                    message: "{0} objects",
                    args: [count],
                    comment: ["{0} is the number of objects"],
                }),
            helpButton: l10n.t("Help"),
            scriptButton: l10n.t("Script"),
            createButton: l10n.t("Create"),
            saveButton: l10n.t("Save"),
            cancelButton: l10n.t("Cancel"),
        };
    }
