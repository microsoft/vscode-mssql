...
export class LocConstants {
    ...
    public get schemaDesigner() {
        return {
            ...
            pendingAiChangesPanelTitle: (changeCount: number) =>
                l10n.t({
                    message: "Pending AI Changes ({0})",
                    args: [changeCount],
                    comment: ["{0} is the number of pending AI changes"],
                }),
            pendingAiTabLabel: l10n.t("Pending AI Changes"),
            pendingAiEmptyTitle: l10n.t("No pending AI changes"),
            pendingAiEmptySubtitle: l10n.t("Apply AI edits to track pending AI changes here."),
            failedToCreateForeignKey: l10n.t("Failed to create foreign key"),
            keep: l10n.t("Keep"),
            ...
            aiLedgerDeletedSuffix: l10n.t("(deleted)"),
            aiLedgerUnnamed: l10n.t("(unnamed)"),
            aiLedgerActionAdd: l10n.t("Add"),
            aiLedgerActionDelete: l10n.t("Delete"),
            aiLedgerActionModify: l10n.t("Modify"),
            aiLedgerCategoryTable: l10n.t("table"),
            aiLedgerCategoryColumn: l10n.t("column"),
            aiLedgerCategoryForeignKey: l10n.t("foreign key"),
