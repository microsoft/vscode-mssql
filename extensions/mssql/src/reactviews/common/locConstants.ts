...
export class LocConstants {
  ...
  public get azure() {
    return {
      ...
      clickToSignIntoAnAzureAccount: l10n.t(
      ...
      toggleToGridView: (shortcut: string) => {
        if (shortcut) {
          return l10n.t({
            ...
            args: [shortcut],
            comment: [
              "{0} is the keyboard shortcut for switching to grid view",
            ],
          });
        }
      ...
      toggleToTextView: (shortcut: string) => {
        if (shortcut) {
          return l10n.t({
            ...
            args: [shortcut],
            comment: [
              "{0} is the keyboard shortcut for switching to text view",
            ],
          });
        }
  ...
  public get schemaDesigner() {
    return {
      ...
      foreignKeyNameEmptyWarning: l10n.t(
        "Consider adding a name for this foreign key",
      ),
      ...
      possibleDataLoss: l10n.t(
        "Possible Data Loss detected. Please review the changes.",
      ),
  ...
  public get publishProject() {
    return {
      ...
      RevertSqlCmdVariablesToDefaults: l10n.t(
  ...
  public get deployment() {
    return {
      ...
      fabricProvisioningHeader: l10n.t(
  ...
  public get localContainers() {
    return {
      ...
      learnMoreAboutSqlServer2025: l10n.t(
        "Learn more about SQL Server 2025 features",
      ),
      sqlServerEditionsComparison: l10n.t("Compare SQL Server editions"),
      configureAndCustomizeSqlServer: l10n.t(
        "Configure and customize SQL Server containers",
      ),
      ...
      gettingContainerReadyForConnection: l10n.t(
  ...
  public get dacpacDialog() {
    return {
      ...
      deployDescription: l10n.t(
        "Deploy a .dacpac file to a new or existing SQL database",
      ),
      extractDescription: l10n.t(
        "Extract the schema from a SQL database to a .dacpac file",
      ),
      importDescription: l10n.t(
        "Import a .bacpac file to a new or empty database",
      ),
  ...
  public get tableExplorer() {
    return {
      ...
      noPendingChanges: l10n.t(
        "No pending changes. Make edits to generate a script.",
      ),
