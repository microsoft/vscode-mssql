    ...
    const formFields = (
        <div className={styles.fieldGroup}>
            ...
            <Field
                ...
                validationState={isPasswordEmpty && password !== "" ? "error" : "none"}>
                <Input
                    size="medium"
                    type={showPassword ? "text" : "password"}
                    placeholder={locConstants.changePasswordDialog.newPasswordPlaceholder}
                    required
                    value={password}
                    onChange={(_, data) => setPassword(data.value)}
                    contentAfter={
                        <Button
                            ...
                            title={
                                showPassword
                                    ? locConstants.changePasswordDialog.hideNewPassword
                                    : locConstants.changePasswordDialog.showNewPassword
                            }
                            icon={showPassword ? <EyeRegular /> : <EyeOffRegular />}></Button>
                    }
                />
            </Field>
            <Field
                ...
                <Input
                    ...
                    placeholder={locConstants.changePasswordDialog.confirmPasswordPlaceholder}
                    required
                    ...
                    contentAfter={
                        <Button
                            ...
                            title={
                                showConfirmPassword
                                    ? locConstants.changePasswordDialog.hideConfirmPassword
                                    : locConstants.changePasswordDialog.showConfirmPassword
                            }
                            icon={
                                showConfirmPassword ? <EyeRegular /> : <EyeOffRegular />
                            }></Button>
                    }
                />
            </Field>
