...
const ConnectionGroupContext = createContext<
  ConnectionGroupContextProps | undefined
>(undefined);
...
const ConnectionGroupStateProvider: React.FC<ConnectionGroupProviderProps> = ({
  children,
}) => {
    ...
    <ConnectionGroupContext.Provider
      value={{
        ...
        saveConnectionGroup: (connectionGroupSpec: ConnectionGroupSpec) =>
          webviewContext?.extensionRpc.action(
            "saveConnectionGroup",
            connectionGroupSpec,
          ),
      }}
