...
const AddFirewallRuleContext = createContext<
  AddFirewallRuleContextProps | undefined
>(undefined);
...
const AddFirewallRuleStateProvider: React.FC<AddFirewallRuleProviderProps> = ({
  children,
}) => {
