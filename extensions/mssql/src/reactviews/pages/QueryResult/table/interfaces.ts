...
export const defaultTableStyles: ITableStyles = {
  ...
  nullCellSelectionBackground:
    "var(--vscode-mssql-resultsGridNullSelectedBackground)",
  nullCellSelectionForeground:
    "var(--vscode-mssql-resultsGridNullSelectedForeground)",
  ...
  nullCellHoverSelectionBackground:
    "var(--vscode-mssql-resultsGridNullHoverSelectionBackground)",
  nullCellHoverSelectionForeground:
    "var(--vscode-mssql-resultsGridNullHoverSelectionForeground)",
