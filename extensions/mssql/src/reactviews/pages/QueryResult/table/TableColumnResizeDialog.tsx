...
import {
  MAX_COLUMN_WIDTH_PX as maxWidth,
  MIN_COLUMN_WIDTH_PX as minWidth,
} from "../table/table";
...
export const TableColumnResizeDialog: React.FC<
  TableColumnResizeDialogProps
> = ({ open, columnName, initialWidth, onSubmit, onDismiss }) => {
  const [inputValue, setInputValue] = useState<string>(
    Math.round(initialWidth).toString(),
  );
  ...
  return (
    ...
    >
      <DialogSurface>
        <DialogBody>
          <DialogTitle>
            {locConstants.queryResult.resizeColumn(columnName)}
          </DialogTitle>
          <DialogContent>
            <Field
