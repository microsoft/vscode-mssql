...
export const QueryResultCommandsContext = createContext<
  QueryResultReactProvider | undefined
>(undefined);
...
const QueryResultStateProvider: React.FC<QueryResultProviderProps> = ({
  ...
  const [filterPopupState, setFilterPopupState] = useState<
    ColumnFilterPopupOptions | undefined
  >(undefined);

  const [resizeDialogState, setResizeDialogState] =
    useState<ResizeColumnDialogState>({
      open: false,
      columnId: "",
      columnName: "",
      initialWidth: 0,
