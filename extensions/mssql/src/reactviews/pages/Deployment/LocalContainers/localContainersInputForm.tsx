...
export const LocalContainersInputForm: React.FC = () => {
  ...
  const localContainersState =
    deploymentState?.deploymentTypeState as LocalContainersState;
    ...
    <div>
      ...
      <div className={classes.outerDiv}>
        <div className={classes.formDiv}>
          {deploymentState.dialog?.type === "createConnectionGroup" && (
            <ConnectionGroupDialog
              state={
                (deploymentState.dialog as CreateConnectionGroupDialogProps)
                  .props
              }
          ...
          {deploymentState.dialog?.type === "armSql2025Error" && (
            <ArmSql2025ErrorDialog
              closeDialog={context.closeArmSql2025ErrorDialog}
            />
          )}
        ...
        <div className={classes.bottomDiv}>
          ...
          {localContainersState.formValidationLoadState ===
          ApiStatus.Loading ? (
            <Button
