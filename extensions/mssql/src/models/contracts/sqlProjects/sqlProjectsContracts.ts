...
export namespace CreateSqlProjectRequest {
    export const type = new RequestType<mssql.CreateSqlProjectParams, mssql.ResultStatus, void>(
        "sqlProjects/createProject",
    );
}

export namespace OpenSqlProjectRequest {
    export const type = new RequestType<mssql.SqlProjectParams, mssql.ResultStatus, void>(
...
export namespace SetProjectPropertiesRequest {
    export const type = new RequestType<mssql.SetProjectPropertiesParams, mssql.ResultStatus, void>(
...
export namespace MoveSqlObjectScriptRequest {
    export const type = new RequestType<mssql.MoveItemParams, mssql.ResultStatus, void>(
...
export namespace MoveFolderRequest {
    export const type = new RequestType<mssql.MoveFolderParams, mssql.ResultStatus, void>(
...
export namespace AddSqlCmdVariableRequest {
    export const type = new RequestType<mssql.AddSqlCmdVariableParams, mssql.ResultStatus, void>(
        "sqlProjects/addSqlCmdVariable",
    );
}

export namespace DeleteSqlCmdVariableRequest {
    export const type = new RequestType<mssql.DeleteSqlCmdVariableParams, mssql.ResultStatus, void>(
...
export namespace AddDacpacReferenceRequest {
    export const type = new RequestType<mssql.AddDacpacReferenceParams, mssql.ResultStatus, void>(
