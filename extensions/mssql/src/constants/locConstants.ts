...
export let msgSelectNodeToScript = l10n.t(
...
export function msgScriptingObjectNotFound(
  nodeType: string,
  nodeLabel: string,
): string {
  return l10n.t({
...
export let msgScriptingEditorFailed = l10n.t(
  "Failed to open script in editor.",
);
...
export let searchObjectsPrompt = l10n.t(
  "Enter part of an object name to search for",
);
...
export let searchObjectsError = l10n.t(
  "An error occurred while searching database objects",
);
...
export class ObjectExplorer {
  ...
  public static FailedOEConnectionErrorUpdate = l10n.t(
  ...
  public static ConnectionGroupDeletionConfirmationWithContents(
    groupName: string,
  ) {
    return l10n.t({
      message:
  ...
  public static ConnectionGroupDeletionConfirmationWithoutContents(
    groupName: string,
  ) {
    return l10n.t({
...
export class ConnectionDialog {
  ...
  public static microsoftAccountIsRequired = l10n.t(
  ...
  public static multipleMatchingTokensError(
  ...
  public static clearCacheAndRefreshToken = l10n.t(
...
export class Azure {
  ...
  public static failedToGetTenantForAccount = (
    tenantId: string,
    accountName: string,
  ) => {
    return l10n.t({
...
export class Fabric {
  ...
  public static fabricLongRunningApiError = (
    resultCode: string,
    error: string,
  ) => {
    return l10n.t({
  ...
  public static insufficientWorkspacePermissions = l10n.t(
    "Insufficient Workspace Permissions",
  );

  public static fabricNotSupportedInCloud = (
    cloudName: string,
    settingName: string,
  ) => {
    return l10n.t({
...
export class Accounts {
  ...
  public static clearedEntraTokenCache = l10n.t(
...
export class QueryResult {
  ...
  public static numericSelectionSummary = (
    average: string,
    count: number,
    sum: number,
  ) =>
  ...
  public static clickToCancelLoadingSummary = l10n.t(
    "Click to cancel loading summary",
  );
  public static summaryLoadingCanceled = l10n.t("Summary loading canceled");
  public static summaryLoadingCanceledTooltip = l10n.t(
    "Summary loading was canceled by user",
  );
...
export class LocalContainers {
  ...
  public static selectImageTooltip = l10n.t(
    "Select the SQL Server Container Image",
  );
  ...
  public static sqlServerPasswordTooltip = l10n.t(
  ...
  public static portTooltip = l10n.t(
    "Choose a port to host the SQL Server Docker Container",
  );
  ...
  public static acceptSqlServerEula = l10n.t(
    "Please Accept the SQL Server EULA",
  );
  public static dockerInstallHeader = l10n.t("Checking if Docker is installed");
  public static dockerInstallBody = l10n.t(
    "Checking if Docker is installed on your machine",
  );
  ...
  public static startDockerEngineHeader = l10n.t(
  ...
  public static settingUpContainerBody = l10n.t(
    "Readying container for connections.",
  );
  ...
  public static msgCreateLocalSqlContainer = l10n.t(
  ...
  public static readyingContainerLoadingLabel = l10n.t(
    "Readying container for connections...",
  );
  ...
  public static configureRosetta = l10n.t(
    "Configure Rosetta in Docker Desktop",
  );
...
export class PublishProject {
  ...
  public static PublishTargetContainer = l10n.t(
    "New SQL Server Local development container",
  );
  public static PublishTargetNewAzureServer = l10n.t(
    "New Azure SQL logical server (Preview)",
  );
  ...
  public static LicenseAcceptanceMessage = l10n.t(
    "You must accept the license",
  );
  public static PublishProfileLoadFailed = l10n.t(
    "Failed to load publish profile",
  );
  public static PublishProfileSavedSuccessfully = (path: string) => {
    return l10n.t("Publish profile saved to: {0}", path);
  };
  public static PublishProfileSaveFailed = l10n.t(
    "Failed to save publish profile",
  );
...
export class SchemaDesigner {
  public static LoadingSchemaDesginerModel = l10n.t(
    "Loading Schema Designer Model...",
  );
  ...
  public static OpeningPublishScript = l10n.t(
    "Opening Publish Script. This may take a while...",
  );
  public static GeneratingReport = l10n.t(
...
export class Connection {
  ...
  public static missingConnectionIdsError = (
  ...
  public static errorMigratingLegacyConnection = (
    connectionId: string,
    errorMessage: string,
  ) => {
    return l10n.t({
...
export class MssqlChatAgent {
  ...
  public static gotInvalidToolUseParameters = (
    partInput: string,
    errorMessage: string,
  ) => {
    return l10n.t({
  ...
  public static callingTool = (
    toolFunctionName: string,
    sqlToolParameters: string,
  ) => {
    return l10n.t({
  ...
  public static unknownErrorOccurred = l10n.t(
  ...
  public static connectionRequiredMessage = (buttonText: string) => {
    return l10n.t({
      ...
      args: [buttonText],
      comment: [
        "{0} is the button text (e.g., 'Connect' or 'Open SQL editor and connect')",
      ],
    });
  };
  // Follow-up questions
  public static followUpConnectToDatabase = l10n.t("Connect to a database");
  public static followUpShowRandomTableDefinition = l10n.t(
    "Show a random table definition",
  );
  public static followUpCountTables = l10n.t(
  ...
  public static listServersToolInvocationMessage = l10n.t(
    "Listing server connections",
  );
  public static connectToolConfirmationTitle = l10n.t("Connect to Server");
  public static connectToolConfirmationMessageWithServerOnly = (
    serverName: string,
  ) => {
    return l10n.t({
  ...
  public static connectToolInvocationMessageWithServerOnly = (
    serverName: string,
  ) => {
    return l10n.t({
  ...
  public static connectToolSuccessMessage = l10n.t(
  ...
  public static connectToolConfirmationMessageWithProfile = (
    profileId: string,
  ) => {
    return l10n.t({
  ...
  public static connectToolInvocationMessageWithProfile = (
    profileId: string,
  ) => {
    return l10n.t({
  ...
  public static showSchemaToolSuccessMessage = l10n.t(
    "Schema visualization opened.",
  );
  public static getConnectionDetailsToolConfirmationTitle = l10n.t(
  ...
  public static databaseChangedSuccessfully = l10n.t(
  ...
  public static noConnectionInformationFound = l10n.t(
  ...
  public static noConnectionCredentialsFound = l10n.t(
    "No connection credentials found",
  );
  public static noActiveConnectionForSchemaView = l10n.t(
    "No active connection for schema view",
  );
  public static availableServers = l10n.t("Available Servers");
  public static noSavedConnectionProfilesFound = l10n.t(
...
export class ConnectionSharing {
  ...
  public static invalidConnectionUri = l10n.t(
...
export class DacpacDialog {
  ...
  public static ValidationFailed = l10n.t(
...
export class TableExplorer {
  ...
  public static changesSavedSuccessfully = l10n.t(
...
export class Changelog {
  ...
  public static customizeKeyboardShortcuts = l10n.t(
