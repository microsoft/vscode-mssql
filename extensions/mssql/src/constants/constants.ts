...
/**
 * Opens the Getting Started page from its Object Explorer node. Menu items take their label from the
 * command, so this exists only to read as "Open" next to the node rather than the full title.
 */
