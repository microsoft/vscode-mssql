...
export class LocConstants {
    ...
    public get runbookStudio() {
        return {
            ...
            derivedView: l10n.t("Derived view"),
            ...
            topRows: l10n.t("Sort and limit rows"),
            selectColumns: l10n.t("Select columns"),
            renameColumns: l10n.t("Rename columns"),
            filterRows: l10n.t("Filter rows"),
            summarizeRows: l10n.t("Summarize rows"),
            pivotRows: l10n.t("Pivot rows"),
            timeSeries: l10n.t("Create time series"),
            columnsCommaSeparated: l10n.t("Columns (comma-separated)"),
            sortFieldsOptional: l10n.t("Sort fields (optional)"),
            field: l10n.t("Field"),
            fieldOptional: l10n.t("Field (optional)"),
            sortDirection: l10n.t("Sort direction"),
            descending: l10n.t("Descending"),
            ascending: l10n.t("Ascending"),
            addSort: l10n.t("Add sort field"),
            removeSort: l10n.t("Remove sort field"),
            maximumRows: l10n.t("Maximum rows"),
            sourceColumn: l10n.t("Source column"),
            outputColumn: l10n.t("Output column"),
            addRename: l10n.t("Add column rename"),
            removeRename: l10n.t("Remove column rename"),
            matchConditions: l10n.t("Match"),
            matchAll: l10n.t("All conditions"),
            matchAny: l10n.t("Any condition"),
            negateFilter: l10n.t("Invert result"),
            operator: l10n.t("Operator"),
            equals: l10n.t("Equals"),
            notEquals: l10n.t("Does not equal"),
            greaterThan: l10n.t("Greater than"),
            greaterThanOrEqual: l10n.t("Greater than or equal"),
            lessThan: l10n.t("Less than"),
            lessThanOrEqual: l10n.t("Less than or equal"),
            inList: l10n.t("Is in list"),
            isNull: l10n.t("Is null"),
            isNotNull: l10n.t("Is not null"),
            valueType: l10n.t("Value type"),
            valuesCommaSeparated: l10n.t("Values (comma-separated)"),
            stringValue: l10n.t("Text"),
            numberValue: l10n.t("Number"),
            booleanValue: l10n.t("Boolean"),
            nullValue: l10n.t("Null"),
            trueValue: l10n.t("True"),
            falseValue: l10n.t("False"),
            addCondition: l10n.t("Add condition"),
            removeCondition: l10n.t("Remove condition"),
            groupByColumnsOptional: l10n.t("Group by columns (comma-separated, optional)"),
            measures: l10n.t("Measures"),
            function: l10n.t("Function"),
            count: l10n.t("Count"),
            countDistinct: l10n.t("Count distinct"),
            sum: l10n.t("Sum"),
            average: l10n.t("Average"),
            minimum: l10n.t("Minimum"),
            maximum: l10n.t("Maximum"),
            addMeasure: l10n.t("Add measure"),
            removeMeasure: l10n.t("Remove measure"),
            pivotIndexColumns: l10n.t("Index columns (comma-separated)"),
            pivotColumn: l10n.t("Column containing pivot names"),
            pivotValueColumn: l10n.t("Column containing values"),
            reducer: l10n.t("Reducer"),
            timeField: l10n.t("Time field"),
            measureFields: l10n.t("Measure fields (comma-separated)"),
            derivedSourceExists: l10n.t("A derived source with this ID already exists."),
            stageDerivedView: l10n.t("Stage derived view"),
            stageDerivedUpdate: l10n.t("Stage transform update"),
            cancel: l10n.t("Cancel"),
            ...
            layoutConflictDerivedSource: l10n.t("derived transform"),
            ...
            runtimeNodeType: l10n.t("Runtime node"),
            runtimeRole: l10n.t("Runtime role"),
            decisionBranches: l10n.t("Decision branches"),
            parallelBranches: l10n.t("Parallel branches"),
            joinsAt: l10n.t("Joins at"),
            approvalKind: l10n.t("Approval kind"),
            approvalReason: l10n.t("Approval reason"),
            approvalRoutes: l10n.t("Approval routes"),
            ...
            compareRuns: l10n.t("Compare runs"),
            runComparison: l10n.t("Run comparison"),
            runComparisonDetail: l10n.t(
                "Compare durable outcomes, timing, diagnostics, rows, and runtime metrics.",
            ),
            compareWith: l10n.t("Compare with"),
            loadingComparison: l10n.t("Loading comparison…"),
            comparisonLoadFailed: l10n.t("The comparison run could not be loaded."),
            noComparisonRun: l10n.t("No other completed run is available to compare."),
            baseline: l10n.t("Baseline"),
            current: l10n.t("Current"),
            change: l10n.t("Change"),
            samePlan: l10n.t("Same plan"),
            differentPlan: l10n.t("Different plan revisions"),
            elapsed: l10n.t("Elapsed"),
            completedSteps: l10n.t("Completed steps"),
            warnings: l10n.t("Warnings"),
            errors: l10n.t("Errors"),
            comparisonNoRegressionClaim: l10n.t(
                "Deltas are observed facts only. No performance baseline or noise policy is applied.",
            ),
            changedSteps: l10n.t("Changed steps"),
            durationChange: l10n.t("Duration change"),
            rowChange: l10n.t("Row change"),
            noChangedSteps: l10n.t("No step facts changed."),
            changedMetrics: l10n.t("Changed runtime metrics"),
            metric: l10n.t("Metric"),
            noChangedMetrics: l10n.t("No runtime metrics changed."),
            runOutcome: l10n.t("Run outcome"),
            runPassed: l10n.t("Passed"),
            runFailed: l10n.t("Failed"),
            runIndeterminate: l10n.t("Indeterminate"),
            runAccepted: l10n.t("Accepted"),
            runRunning: l10n.t("Running"),
            runAwaitingApproval: l10n.t("Awaiting approval"),
            runCancelling: l10n.t("Cancelling"),
            runSucceeded: l10n.t("Succeeded"),
            runCancelled: l10n.t("Cancelled"),
            steps: l10n.t("Steps"),
            failedSteps: (count: number) =>
                l10n.t({
                    message: "{0} failed",
                    args: [count],
                    comment: ["{0} is a count of failed runbook steps"],
                }),
            cancelledSteps: (count: number) =>
                l10n.t({
                    message: "{0} cancelled",
                    args: [count],
                    comment: ["{0} is a count of cancelled runbook steps"],
                }),
            skippedSteps: (count: number) =>
                l10n.t({
                    message: "{0} skipped",
                    args: [count],
                    comment: ["{0} is a count of skipped runbook steps"],
                }),
            branchNotTakenSteps: (count: number) =>
                l10n.t({
                    message: "{0} branch not taken",
                    args: [count],
                    comment: ["{0} is a count of runbook steps on branches that were not taken"],
                }),
            elapsedNotMeasured: l10n.t("Available when the run reaches a terminal state."),
            durableRunTiming: l10n.t("Measured from the durable run record."),
            diagnostics: l10n.t("Diagnostics"),
            diagnosticTotals: (warnings: number, errors: number) =>
                l10n.t({
                    message: "{0} warnings · {1} errors",
                    args: [warnings, errors],
                    comment: ["{0} is a warning count; {1} is an error count"],
                }),
            notMeasured: l10n.t("Not measured"),
            runtimeMeasured: l10n.t("Reported by the runtime."),
            diagnosticsNotReported: l10n.t("The runtime did not report diagnostic totals."),
            ciEvidence: l10n.t("CI evidence"),
            evidenceReady: l10n.t("Ready to export"),
            evidencePending: l10n.t("Pending"),
            evidenceMissing: l10n.t("Not produced"),
            evidenceTruncated: l10n.t("Truncated"),
            evidenceExpired: l10n.t("Expired"),
            evidenceStateDetail: {
                ready: l10n.t("An exportable evidence bundle is retained."),
                pending: l10n.t("No exportable evidence bundle has been retained yet."),
                missing: l10n.t("This run did not retain an exportable evidence bundle."),
            ...
            openRunDrop: l10n.t("Open run drop"),
            deleteRun: l10n.t("Delete run"),
            confirmDeleteRun: l10n.t("Confirm delete"),
            cancelDeleteRun: l10n.t("Cancel"),
            deletingRun: l10n.t("Deleting…"),
            deleteRunConfirmation: l10n.t(
                "Delete this run's results, approvals, logs, and retained files?",
            ),
            ...
            labeledRoute: (label: string, target: string) =>
                l10n.t({
                    message: "{0} → {1}",
                    args: [label, target],
                    comment: ["{0} is a runtime-authored branch label", "{1} is a plan step name"],
                }),
