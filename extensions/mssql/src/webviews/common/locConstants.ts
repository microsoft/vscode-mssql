...
export class LocConstants {
    ...
    public get serverDashboard() {
        return {
            ...
            newIssue: l10n.t("New"),
            diagnosed: l10n.t("Diagnosed"),
            actionReady: l10n.t("Action ready"),
            actionProposed: l10n.t("Action proposed"),
            executing: l10n.t("Executing"),
            verifying: l10n.t("Verifying"),
            ...
            availabilityCategory: l10n.t("Availability"),
            storageCategory: l10n.t("Storage"),
            ...
            resourceReadiness: l10n.t("Resource readiness"),
            resourceReadinessDescription: l10n.t("Connectivity, redundancy, and recovery checks"),
            resourceTopology: l10n.t("Resource topology"),
            resourceTopologyDescription: l10n.t(
                "Database endpoints, replicas, and dependent capacity",
            ),
            networkConfiguration: l10n.t("Network configuration"),
            connectionPolicy: l10n.t("Connection policy"),
            publicNetworkAccess: l10n.t("Public network access"),
            privateEndpoint: l10n.t("Private endpoint"),
            minimumTlsVersion: l10n.t("Minimum TLS version"),
            firewallRules: l10n.t("Firewall rules"),
            configuration: l10n.t("Configuration"),
            configurationDescription: l10n.t("Effective database and server settings"),
            source: l10n.t("Source"),
            backupAndRecovery: l10n.t("Backup and recovery"),
            backupType: l10n.t("Backup type"),
            completed: l10n.t("Completed"),
            retention: l10n.t("Retention"),
            recoverableThrough: l10n.t("Recoverable through"),
            fullBackup: l10n.t("Full"),
            differentialBackup: l10n.t("Differential"),
            logBackup: l10n.t("Transaction log"),
            continuousBackup: l10n.t("Continuous"),
            recentActivity: l10n.t("Recent activity"),
            recentActivityDescription: l10n.t("Configuration, health, and administrative events"),
            ...
            activeIssues: l10n.t("Active"),
            resolvedIssues: l10n.t("Resolved"),
            closedIssues: l10n.t("Closed"),
            allSeverities: l10n.t("All severities"),
            allCategories: l10n.t("All categories"),
            filterBySeverity: l10n.t("Filter by severity"),
            filterByCategory: l10n.t("Filter by category"),
            noIssuesInView: l10n.t("No issues match the selected filters."),
            history: l10n.t("History"),
            policies: l10n.t("Policies"),
            settings: l10n.t("Settings"),
            access: l10n.t("Access"),
            agentReadyTitle: l10n.t("Database Agent is ready to help"),
            agentReadyDescription: l10n.t(
                "Register this SQL resource to continuously correlate telemetry, investigate anomalies, and prepare approval-gated mitigations.",
            ),
            connectTelemetry: l10n.t("Connect telemetry"),
            connectTelemetryDescription: l10n.t(
                "Use database metrics, Query Store, waits, and session signals.",
            ),
            configureGuardrails: l10n.t("Configure guardrails"),
            configureGuardrailsDescription: l10n.t(
                "Apply action policies, custom instructions, and approval controls.",
            ),
            startMonitoring: l10n.t("Start monitoring"),
            startMonitoringDescription: l10n.t(
                "Build a workload baseline and begin continuous investigations.",
            ),
            registerDatabaseAgent: l10n.t("Register Database Agent"),
            registered: l10n.t("Registered"),
            notRegistered: l10n.t("Not registered"),
            registrationUnavailable: l10n.t("Database Agent is unavailable"),
            registrationUnavailableDescription: l10n.t(
                "This SQL resource is not currently eligible for Database Agent registration.",
            ),
            registrationInProgress: l10n.t("Registration in progress"),
            registrationInProgressDescription: l10n.t(
                "Database Agent is validating access and connecting telemetry sources.",
            ),
            registrationDegraded: l10n.t("Database Agent has limited functionality"),
            degradedAuthentication: l10n.t(
                "Authentication must be refreshed before the agent can run new investigations.",
            ),
            degradedAuthorization: l10n.t(
                "Additional permissions are required to read telemetry or execute approved actions.",
            ),
            degradedApi: l10n.t(
                "The Database Agent service is temporarily unavailable. Existing findings remain available.",
            ),
            retryRegistration: l10n.t("Retry registration"),
            lastSuccessfulRun: l10n.t("Last successful run"),
            activeInvestigation: l10n.t("Active investigation"),
            viewTimeline: l10n.t("View timeline"),
            hideTimeline: l10n.t("Hide timeline"),
            forceResolve: l10n.t("Force resolve"),
            investigationHistory: l10n.t("Investigation history"),
            noInvestigationHistory: l10n.t("No completed investigations are available."),
            relatedIssues: l10n.t("Related issues"),
            ...
            severityHistory: l10n.t("Severity history"),
            issueRelationships: l10n.t("Issue relationships"),
            blockedByIssues: l10n.t("Blocked by"),
            blockingIssues: l10n.t("Blocks"),
            noRelatedIssues: l10n.t("No related issues"),
            recommendedActions: l10n.t("Recommended actions"),
            actionsTaken: l10n.t("Actions taken"),
            stage: l10n.t("Stage"),
            risk: l10n.t("Risk"),
            confidence: l10n.t("Confidence"),
            execution: l10n.t("Execution"),
            reasoning: l10n.t("Reasoning"),
            expectedOutcome: l10n.t("Expected outcome"),
            rollbackPlan: l10n.t("Rollback plan"),
            parameters: l10n.t("Parameters"),
            approve: l10n.t("Approve"),
            reject: l10n.t("Reject"),
            executeAction: l10n.t("Execute action"),
            markAsApplied: l10n.t("Mark as applied"),
            pending: l10n.t("Pending"),
            approved: l10n.t("Approved"),
            rejected: l10n.t("Rejected"),
            executed: l10n.t("Executed"),
            manuallyApplied: l10n.t("Manually applied"),
            lowRisk: l10n.t("Low"),
            mediumRisk: l10n.t("Medium"),
            highRisk: l10n.t("High"),
            runnerExecution: l10n.t("Agent runner"),
            clientExecution: l10n.t("VS Code client"),
            manualExecution: l10n.t("Manual"),
            validationResult: l10n.t("Validation result"),
            customInstructions: l10n.t("Custom instructions"),
            customInstructionsDescription: l10n.t(
                "Guide investigations and recommendations with resource-specific operational context.",
            ),
            instructionPlaceholder: l10n.t(
                "For example: Never terminate sessions owned by the month-end reporting workload.",
            ),
            addInstruction: l10n.t("Add instruction"),
            revoke: l10n.t("Revoke"),
            createdByAt: (createdBy: string, timestamp: string) =>
                l10n.t({
                    message: "Created by {0} on {1}",
                    args: [createdBy, timestamp],
                    comment: [
                        "{0} is a user display name",
                        "{1} is the localized creation date and time",
                    ],
                }),
            agentSettings: l10n.t("Database Agent settings"),
            agentSettingsDescription: l10n.t(
                "Control notifications and which action categories the agent can recommend.",
            ),
            notifications: l10n.t("Notifications"),
            notifyOnResolve: l10n.t("Notify when an issue is resolved"),
            notifyOnFailure: l10n.t("Notify when an approved action fails"),
            actionPermissions: l10n.t("Action permissions"),
            allowActions: l10n.t("Allow recommendations"),
            requireApproval: l10n.t("Require approval"),
            saveSettings: l10n.t("Save settings"),
            accessAndRoles: l10n.t("Access and roles"),
            accessDescription: l10n.t(
                "Review the current role and approval routing for this SQL resource.",
            ),
            currentRole: l10n.t("Current role"),
            approvingAdmin: l10n.t("Approving admin"),
            registrationStatus: l10n.t("Registration status"),
            administrator: l10n.t("Administrator"),
            contributor: l10n.t("Contributor"),
            reader: l10n.t("Reader"),
            administratorCapabilities: l10n.t(
                "Can configure policies, approve actions, and execute supported mitigations.",
            ),
            contributorCapabilities: l10n.t(
                "Can investigate issues and submit actions for administrator approval.",
            ),
            readerCapabilities: l10n.t(
                "Can review investigations, issue evidence, and action history.",
            ),
            actionCategory: (category: string) =>
                l10n.t({
                    message: "{0} actions",
                    args: [category],
                    comment: ["{0} is a Database Agent issue category"],
                }),
            observedAndBaseline: (metric: string) =>
                l10n.t({
                    message: "{0}: observed value and expected baseline",
                    args: [metric],
                    comment: ["{0} is a database metric name"],
                }),
            issueCount: (count: number) =>
                l10n.t({
                    message: "{0} issues",
                    args: [count],
                    comment: ["{0} is the number of Database Agent issues"],
                }),
        };
    }
