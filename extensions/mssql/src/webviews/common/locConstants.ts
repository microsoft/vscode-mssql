...
export class LocConstants {
    ...
    public get cloudDeployHub() {
        return {
            ...
            backToRuns: l10n.t("Runs"),
            backToEnvironments: l10n.t("Environments"),
            tabEnvironments: l10n.t("Environments"),
            tabRuns: l10n.t("Runs"),
            environmentListHeading: l10n.t("Environments"),
            environmentListEmpty: l10n.t(
                "No environments declared. Add one to .mssql/environments.json to get started.",
            ),
            environmentListDefaultBadge: l10n.t("Default"),
            environmentListLastRun: l10n.t("Last run"),
            environmentListNoRuns: l10n.t("No runs yet"),
            environmentListValidate: l10n.t("Validate"),
            refresh: l10n.t("Refresh"),
            ...
            sourceKindShadow: l10n.t("Shadow project (decomposed)"),
            ...
            runSourceOfTruthLabel: l10n.t("Source of truth"),
            ...
            deleteRunConfirm: (runId: string) =>
                l10n.t({
                    message:
                        "Delete run {0}? This permanently removes the .cdrun.zip artifact from disk.",
                    args: [runId],
                    comment: ["{0} is a short run id (first 8 chars)"],
                }),
            deleteRunFailed: (reason: string) =>
                l10n.t({
                    message: "Failed to delete run: {0}",
                    args: [reason],
                    comment: ["{0} is the underlying error message"],
                }),
            liveRunsHeading: l10n.t("Currently running"),
            liveRunRow: (envName: string) =>
                l10n.t({
                    message: "Validating {0}...",
                    args: [envName],
                    comment: ["{0} is an environment display name"],
                }),
            findingsNone: l10n.t("No findings."),
            findingsNoneConnectivity: l10n.t("No connection findings."),
            findingsNoneStaticAnalysis: l10n.t("No static-analysis findings."),
            findingsNoneUnitTests: l10n.t("No tests executed."),
            findingsNoneWorkload: l10n.t("No workload regressions."),
            colSeverity: l10n.t("Severity"),
            colOutcome: l10n.t("Outcome"),
            colMessage: l10n.t("Message"),
            colRule: l10n.t("Rule"),
            colLocation: l10n.t("Location"),
            colTestName: l10n.t("Test"),
            colDuration: l10n.t("Duration"),
            colStep: l10n.t("Step"),
            ...
            summaryWarning: l10n.t("Warnings"),
            summaryInfo: l10n.t("Info"),
            summaryPassed: l10n.t("Passed"),
            summaryFailed: l10n.t("Failed"),
            summarySkipped: l10n.t("Skipped"),
            summaryErrored: l10n.t("Errored"),
            summaryTotal: l10n.t("Total"),
            summarySteps: l10n.t("Steps"),
            summaryRegressions: l10n.t("Regressions"),
            changesHeader: l10n.t("Observed changes"),
            changeSeverityPass: l10n.t("Pass"),
            changeSeverityWarning: l10n.t("Warning"),
            changeSeverityFail: l10n.t("Fail"),
