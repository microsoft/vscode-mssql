...
export class LocConstants {
    ...
    public get schemaDesigner() {
        return {
            ...
            definitionFormatAriaLabel: l10n.t("Definition format"),
            definitionFormatTsql: l10n.t("T-SQL"),
            definitionFormatPrisma: l10n.t("Prisma"),
            definitionFormatSequelize: l10n.t("Sequelize"),
            definitionFormatTypeOrm: l10n.t("TypeORM"),
            definitionFormatDrizzleOrm: l10n.t("Drizzle ORM"),
            definitionFormatSqlAlchemy: l10n.t("SQLAlchemy"),
            definitionFormatEfCore: l10n.t("EF Core"),
            copy: l10n.t("Copy"),
            close: l10n.t("Close"),
