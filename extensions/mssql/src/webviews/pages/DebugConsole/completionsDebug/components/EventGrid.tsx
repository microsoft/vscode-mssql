...
// FORKED from webviews/pages/InlineCompletionDebug/components/EventGrid.tsx — console-hosted
// copy; the standalone panel remains the reference until replay parity is confirmed, then it
// gets deleted.
...
import { useInlineCompletionDebugContext } from "../consoleStateProvider";
import { getInfoText } from "../LivePage";
...
function toDebugEvent(gridRow: InlineCompletionDebugGridRow): InlineCompletionDebugEvent {
    // Shallow-copy + delete instead of rest-omission: this repo's lint config
    // flags computed-key omission bindings as unused variables.
    const event = { ...gridRow } as Partial<InlineCompletionDebugGridRow>;
    delete event[GRID_ROW_ID_PROPERTY];
    delete event[GRID_SELECTION_ID_PROPERTY];
    return event as InlineCompletionDebugEvent;
}
