...
export const ProviderNotFoundForProjectTypeError = (projectType: string): string => {
  return localize(
...
export const fileDoesNotExist = (name: string): string => {
  return localize("fileDoesNotExist", "File '{0}' doesn't exist", name);
};
export const projectNameNull = localize("projectNameNull", "Project name is null");
export const noPreviousData = (tableName: string): string => {
  return localize(
    "noPreviousData",
...
export const gitCloneMessage = (url: string): string => {
  return localize("gitCloneMessage", "Cloning git repository '{0}'...", url);
};
export const gitCloneError = localize(
  "gitCloneError",
  "Error during git clone. View git output for more details",
);
export const openedProjectsUndefinedAfterRefresh = localize(
  "openedProjectsUndefinedAfterRefresh",
  "List of opened projects should not be undefined after refresh from disk.",
);
export const dragAndDropNotSupported = localize(
  "dragAndDropNotSupported",
  "This project type does not support drag and drop.",
);
export const onlyMovingOneFileIsSupported = localize(
  "onlyMovingOneFileIsSupported",
  "Only moving one file at a time is supported.",
);
export const noProjectProvidingExtensionsInstalled = localize(
  "noProjectProvidingExtensionsInstalled",
...
// New Project Dialog
export const NewProjectDialogTitle = localize(
  "dataworkspace.NewProjectDialogTitle",
...
export const ProjectNamePlaceholder = localize(
  "dataworkspace.projectNamePlaceholder",
  "Enter project name",
);
...
export const ProjectLocationPlaceholder = localize(
  "dataworkspace.projectLocationPlaceholder",
  "Select location to create project",
);
export const ProjectParentDirectoryNotExistError = (location: string): string => {
  return localize(
    "dataworkspace.projectParentDirectoryNotExistError",
...
export const ProjectDirectoryAlreadyExistErrorShort = (projectName: string) => {
  return localize(
    "dataworkspace.projectDirectoryAlreadyExistErrorShort",
    "Directory '{0}' already exists in the selected location, please choose another",
    projectName,
  );
};
export const SelectProjectType = localize(
  "dataworkspace.selectProjectType",
  "Select Database Project Type",
);
export const SelectProjectLocation = localize(
  "dataworkspace.selectProjectLocation",
  "Select Project Location",
);
export const NameCannotBeEmpty = localize(
  "dataworkspace.nameCannotBeEmpty",
...
export const SdkLearnMorePlaceholder = localize(
  "dataworkspace.sdkLearnMorePlaceholder",
...
export const SelectTargetPlatform = localize(
  "dataworkspace.selectTargetPlatform",
  "Select Target Platform",
);
export const LocalDevInfo = (target: string) =>
  localize(
    "LocalDevInfo",
    'Click "Learn more" button for more information about local development experience to {0}',
    target,
  );
export const undefinedFilenameErrorMessage = localize(
  "undefinedFilenameErrorMessage",
  "Undefined name",
);
export const filenameEndingIsPeriodErrorMessage = localize(
  "filenameEndingInPeriodErrorMessage",
  "File name cannot end with a period",
);
export const whitespaceFilenameErrorMessage = localize(
  "whitespaceFilenameErrorMessage",
  "File name cannot be whitespace",
);
export const invalidFileCharsErrorMessage = localize(
  "invalidFileCharsErrorMessage",
  "Invalid file characters",
);
export const reservedWindowsFilenameErrorMessage = localize(
  "reservedWindowsFilenameErrorMessage",
  "This file name is reserved for use by Windows. Choose another name and try again",
);
export const reservedValueErrorMessage = localize(
  "reservedValueErrorMessage",
  "Reserved file name. Choose another name and try again",
);
export const trailingWhitespaceErrorMessage = localize(
  "trailingWhitespaceErrorMessage",
  "File name cannot start or end with whitespace",
);
export const tooLongFilenameErrorMessage = localize(
  "tooLongFilenameErrorMessage",
  "File name cannot be over 255 characters",
);
export const confirmCreateProjectWithBuildTaskDialogName = localize(
...
export const OpenExistingDialogTitle = localize(
  "dataworkspace.openExistingDialogTitle",
  "Open Existing Project",
);
export const FileNotExistError = (fileType: string, filePath: string): string => {
  return localize(
    "dataworkspace.fileNotExistError",
    "The selected {0} file '{1}' does not exist or is not a file.",
    fileType,
    filePath,
  );
};
export const CloneParentDirectoryNotExistError = (location: string): string => {
  return localize(
    "dataworkspace.cloneParentDirectoryNotExistError",
...
export const ProjectFilePlaceholder = localize(
  "dataworkspace.projectFilePlaceholder",
  "Select project file",
);
export const WorkspacePlaceholder = localize(
  "dataworkspace.workspacePlaceholder",
  "Select workspace ({0}) file",
  WorkspaceFileExtension,
);
export const ProjectAlreadyOpened = (path: string): string => {
  return localize("dataworkspace.projectAlreadyOpened", "Project '{0}' is already opened.", path);
};
...
export const GitRepoUrlPlaceholder = localize(
  "dataworkspace.gitRepoUrlPlaceholder",
  "Enter remote git repository URL",
);
export const LocalClonePathTitle = localize(
  "dataworkspace.localClonePathTitle",
  "Local clone path",
);
export const LocalClonePathPlaceholder = localize(
  "dataworkspace.localClonePathPlaceholder",
