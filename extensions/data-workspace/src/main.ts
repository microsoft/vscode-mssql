...
export async function activate(context: vscode.ExtensionContext): Promise<IExtension> {
    ...
    return instantiationService.createInstance(DataWorkspaceActivation).activate();
}

export function deactivate(): void {}

class DataWorkspaceActivation {
    constructor(
    ...
    async activate(): Promise<IExtension> {
        ...
        Logger.log(
            `Registering commands took ${new Date().getTime() - registerCommandStartTime}ms`,
        );
