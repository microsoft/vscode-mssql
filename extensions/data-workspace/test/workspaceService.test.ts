...
suite("WorkspaceService", function (): void {
    ...
    test("getProjectsInWorkspace", async () => {
        ...
        expect(projects[0].path, "first project should be abc.sqlproj").to.equal(project1.path);
        expect(projects[1].path, "second project should be abc1.sqlproj").to.equal(project2.path);
        expect(projects[2].path, "third project should be abc2.sqlproj").to.equal(project3.path);
    });
    ...
    test("getAllProjectTypes", async () => {
        ...
        expect(
            projectTypes[0].projectFileExtension,
            "first project type should be testproj",
        ).to.equal("testproj");
        expect(
        ...
        expect(
            projectTypes[2].projectFileExtension,
            "third project type should be sqlproj",
        ).to.equal("sqlproj");
        expect(extension1.activationStub, "extension1.activate() should not have been called").to
            .not.have.been.called;
        expect(extension2.activationStub, "extension2.activate() should not have been called").to
            .not.have.been.called;
        expect(extension3.activationStub, "extension3.activate() should not have been called").to
            .not.have.been.called;
        expect(extension4.activationStub, "extension4.activate() should have been called").to.have
            .been.calledOnce;
        expect(extension5.activationStub, "extension5.activate() should have been called").to.have
            .been.called;
        expect(extension6.activationStub, "extension6.activate() should not have been called").to
            .not.have.been.called;
    ...
    test("getProjectProvider", async () => {
        ...
        expect(extension1.activationStub, "extension1.activate() should not have been called").to
            .not.have.been.called;
        expect(extension2.activationStub, "extension2.activate() should have been called once").to
        ...
        expect(extension2.activationStub, "extension2.activate() should still only be called once")
    ...
    test("addProjectsToWorkspace", async () => {
        ...
        expect(updateWorkspaceFoldersStub, "updateWorkspaceFolders should have been called once").to
            .have.been.calledOnce;
        expect(showInformationMessageStub, "showInformationMessage should be called once").to.have
            .been.calledOnce;
    ...
    test("createProject uses values from QuickPick", async () => {
        ...
        expect(createProjectStub, "createProject should have been called once").to.have.been
            .calledOnce;
