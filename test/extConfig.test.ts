...
suite('ExtConfig Tests', () => {
    ...
    function createExtConfigInstance(configKey: string, expectedFromConfig: string, expectedFromExtensionConfig: string): ExtConfig {
            ...
            extensionConfig.setup(x => x.get(toolsConfigKey)).returns(() => expectedFromExtensionConfig);
            let extConfig = new ExtConfig(config.object, extensionConfig.object, workspaceConfig.object);
            return extConfig;
    }
    ...
    setup(() => {
        ...
        extensionConfig = TypeMoq.Mock.ofInstance<WorkspaceConfiguration>(configInstance, TypeMoq.MockBehavior.Strict);
        workspaceConfig = TypeMoq.Mock.ofInstance<WorkspaceConfiguration>(configInstance, TypeMoq.MockBehavior.Strict);
    });
