...
import { LocalContainerWebviewController } from "../../src/deployment/localContainerWebviewController";
...
import * as dockerUtils from "../../src/deployment/localContainerDockerUtils";
import {
...
suite("LocalContainerWebviewController", () => {
    let sandbox: sinon.SinonSandbox;
    let mockContext: vscode.ExtensionContext;
    let mainController: MainController;
    let controller: LocalContainerWebviewController;
    ...
    setup(async () => {
        ...
        controller = new LocalContainerWebviewController(
            mockContext,
            vscodeWrapper.object,
            mainController,
        );
