...
suite("Docker Utilities", () => {
    ...
    test("checkDockerInstallation: should check Docker installation and return correct status", async () => {
        ...
        expect(result.success, "Should return success when Docker is installed").to.be.ok;
        expect(result.error).to.equal(undefined);
        expect(result.fullErrorText).to.equal(undefined);

        expect(spawnStub).to.have.been.calledOnce;
        expect(spawnStub).to.have.been.calledWith("docker", ["--version"]);
    });
    ...
    test("checkDockerInstallation: should check Docker installation and return correct error status", async () => {
        ...
        // Test the actual behavior
        expect(!result.success, "Should return failure when Docker is not installed").to.be.ok;
    ...
    test("startDocker: should return success when Docker is already running", async () => {
        ...
        expect(result.success, "Docker is already running, should be successful").to.be.ok;
        expect(spawnStub).to.have.been.calledOnce;
        expect(spawnStub).to.have.been.calledWith("docker", ["info"]);
    });
    ...
    test("startDocker: should start Docker successfully on Windows when not running", async () => {
        ...
        const result = await dockerUtils.startDocker();
        expect(result.error).to.equal(undefined);
        expect(result.success, "Docker should start successfully on Windows").to.be.ok;
    ...
    test("startDocker: should start Docker successfully on Linux when not running", async () => {
        ...
        const result = await dockerUtils.startDocker();
        expect(result.success, "Docker should start successfully on Linux").to.be.ok;
    ...
    test("startDocker: should fail on unsupported platform", async () => {
        ...
        const result = await dockerUtils.startDocker();
        expect(!result.success, "Should not succeed on unsupported platform").to.be.ok;
        expect(result.error).to.equal(
            LocalContainers.unsupportedDockerPlatformError("fakePlatform"),
        );
    });
    ...
    test("startDocker: should fail on Windows when Docker is not installed", async () => {
        ...
        const result = await dockerUtils.startDocker();
        expect(!result.success, "Should fail if Docker is not installed").to.be.ok;
    ...
    test("restartContainer: should restart the container and return success or error", async () => {
        ...
        expect(result, "Should return success when container is already running").to.be.ok;
        spawnStub.resetHistory();
        ...
        expect(result, "Should return success when container is restarted successfully").to.be.ok;
    ...
    test("deleteContainer: should delete the container and return success or error", async () => {
        ...
        expect(spawnStub.calledWith("docker", ["stop", "testContainer"])).to.be.ok;
        expect(spawnStub.calledWith("docker", ["rm", "testContainer"])).to.be.ok;
        ...
        expect(!result, "Should return false on failure").to.be.ok;
    });
    ...
    test("prepareForDockerContainerCommand: should prepare the command with correct parameters", async () => {
        ...
        expect(result.success, "Should return true if container exists").to.be.ok;
        ...
        expect(!result.success, "Should return false if container does not exist").to.be.ok;
