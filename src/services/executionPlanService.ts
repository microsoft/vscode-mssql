...
export class ExecutionPlanService implements ep.ExecutionPlanProvider {
	constructor(private _sqlToolsClient: SqlToolsServiceClient) {
	}
	async getExecutionPlan(planFile: ep.ExecutionPlanGraphInfo): Promise<ep.GetExecutionPlanResult> {
		try {
