...
export const defaultTableStyles: ITableStyles = {
	...
	listFocusAndSelectionBackground: "var(--vscode-list-focusAndSelectionBackground)",
	listFocusAndSelectionForeground: "var(--vscode-list-focusAndSelectionForeground)",
