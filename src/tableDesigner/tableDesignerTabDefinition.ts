  ...
  const tabComponents: designer.DesignerDataPropertyInfo[] = [
    {
      ...
      componentProperties: {
        ...
        labelForAddNewButton:
          columnTableOptions.labelForAddNewButton ?? "New Column",
  ...
  if (primaryKeyTableOptions) {
    tabComponents.push({
      ...
      componentProperties: {
        ...
        labelForAddNewButton:
          primaryKeyTableOptions.labelForAddNewButton ?? "Add Column",
  ...
  if (columnSpecTableOptions) {
    indexProperties.push({
      ...
      componentProperties: {
        ...
        labelForAddNewButton:
          columnSpecTableOptions.labelForAddNewButton ?? "Add Column",
      } as designer.DesignerTableProperties,
    });
  }
  ...
  if (indexTableOptions) {
    tabComponents.push({
      ...
      componentProperties: {
        ...
        labelForAddNewButton:
          indexTableOptions.labelForAddNewButton ?? "New Index",
      } as designer.DesignerTableProperties,
    });
  }
  ...
  if (foreignKeyTableOptions) {
    tabComponents.push({
      ...
      componentProperties: {
        ...
        labelForAddNewButton:
          foreignKeyTableOptions.labelForAddNewButton ?? "New Foreign Key",
      } as designer.DesignerTableProperties,
    });
  }
...
export function getIssuesForComponent(
  componentPath: designer.DesignerPropertyPath,
  issues: designer.DesignerIssue[],
): string {
  if (!issues || issues.length === 0) {
    return "";
  }
  return issues
    .filter((i) => i.propertyPath?.toString() === componentPath.toString())
    .reduce((acc, issue) => {
