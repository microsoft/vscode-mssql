...
export async function activate(context: vscode.ExtensionContext): Promise<IExtension> {
	...
	return {
		...
		getConnectionString: (connectionContext: string | IConnectionInfo, includePassword?: boolean, includeApplicationName?: boolean) => {
			return controller.connectionManager.getConnectionString(connectionContext, includePassword, includeApplicationName);
		}
	};
}
