...
export async function activate(context: vscode.ExtensionContext): Promise<IExtension> {
	...
	return {
		...
		getConnectionString: (connectionUri: string | undefined, connectionInfo?: IConnectionInfo, includePassword?: boolean) => {
			return controller.connectionManager.getConnectionString(connectionUri, connectionInfo, includePassword);
		}
	};
}
