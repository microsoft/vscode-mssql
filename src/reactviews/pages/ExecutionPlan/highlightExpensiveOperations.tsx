...
> = ({ executionPlanView, setExecutionPlanView, setHighlightOpsClicked }) => {
  ...
  const highlightMetricOptions: string[] = [
    LocalizedConstants.actualElapsedTime,
    LocalizedConstants.actualElapsedCpuTime,
    LocalizedConstants.cost,
    LocalizedConstants.subtreeCost,
    LocalizedConstants.actualNumberOfRows,
    LocalizedConstants.numRowsRead,
    LocalizedConstants.off,
  ];
