...
export const IconStack: React.FC<IconStackProps> = ({
  ...
  return (
    <div
      ...
      style={{
        outline: `2px solid ${utils.seperator(executionPlanState!.theme!)}`,
    ...
    >
      ...
      <hr
        ...
        style={{ background: utils.seperator(executionPlanState!.theme!) }}
      ></hr>
      <div
        id="zoomInButton"
        className={classes.button}
      ...
      >
        {tooltipsEnabled ? (
          <img
            className={classes.buttonImg}
            src={utils.enableTooltip(executionPlanState!.theme!)}
          ...
          <img
            className={classes.buttonImg}
            src={utils.disableTooltip(executionPlanState!.theme!)}
            alt={LocalizedConstants.toggleTooltips}
            width="20"
            height="20"
          />
