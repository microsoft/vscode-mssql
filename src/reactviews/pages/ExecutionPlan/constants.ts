...
// Property 'toUrl' does not exist on type 'NodeRequire'.ts(2339)
let imageBasePath = './images/icons/'; // require.toUrl('./images/icons/');
...
//constant strings
export const propertiesSearchDescription = 'Search properties table'; //localize('ep.propertiesSearchDescription', 'Search properties table');
export const topOperationsSearchDescription = 'Search top operations'; //localize('ep.topOperationsSearchDescription', 'Search top operations');
export const searchPlaceholder = 'Filter for any field...'; //localize('ep.searchPlaceholder', 'Filter for any field...');
