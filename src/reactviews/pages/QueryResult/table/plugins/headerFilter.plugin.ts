                ...
                async (e: Event) => {
                    ...
                    switch (sortState) {
                        case SortProperties.NONE:
                            ...
                            columnFilterState = await this.setSortAscending(
                                $sortButton,
                                column,
                                columnFilterState,
                            );
