...
export const DesignerChangesPreviewButton = () => {
          ...
          <DialogActions>
            ...
            <DialogTrigger action="close">
              <Button
                ...
                onClick={designerContext.provider.continueEditing}
              >
                Continue Editing
              </Button>
            </DialogTrigger>
        ...
        <>
          ...
          <DialogActions>
            <Button
              ...
              disabled={metadata.apiState?.previewState !== LoadState.Loaded}
              appearance="primary"
              onClick={() => {
  ...
  return (
    <Dialog inertTrapFocus={true}>
      ...
      <DialogSurface>
        <DialogBody>
          <DialogTitle>Preview Database Updates</DialogTitle>
          {getDialogContent()}
        </DialogBody>
      </DialogSurface>
    </Dialog>
