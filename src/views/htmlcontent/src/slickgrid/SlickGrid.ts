...
import LocalizationService = require('./LocalizationService');
...
let _: UnderscoreStatic = System._nodeRequire('underscore');
...
@Component({
    ...
    styleUrls: ['../../../../../lib/SlickGrid/slick.grid.css', './SlickGrid.css'],
