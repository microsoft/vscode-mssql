...
export const analyzeQueryPerformancePrompt =
    ...
    "Run EXPLAIN and/or EXPLAIN ANALYZE on the query to get the execution plan and performance metrics. " + // TODO: figure out why this doesn't work
...
export const explainQueryPrompt =
    `@${Constants.mssqlChatParticipantName} Explain this query. ` +
...
export const explainQuerySelectionPrompt =
    `@${Constants.mssqlChatParticipantName} Explain the selected text of this query. ` +
...
export const rewriteQueryPrompt =
    `@${Constants.mssqlChatParticipantName} Rewrite this query. ` +
...
export const rewriteQuerySelectionPrompt =
    `@${Constants.mssqlChatParticipantName} Rewrite the selected text of this query. ` +
