...
export class TableExplorerService implements ITableExplorerService {
    ...
    public async initialize(
        ...
        try {
            ...
            const result = await this._client.sendRequest(EditInitializeRequest.type, params);
    ...
    public async subset(
        ...
        try {
            ...
            const result = await this._client.sendRequest(EditSubsetRequest.type, params);
    ...
    public async commit(ownerUri: string): Promise<EditCommitResult> {
        try {
            ...
            const result = await this._client.sendRequest(EditCommitRequest.type, params);
    ...
    public async createRow(ownerUri: string): Promise<EditCreateRowResult> {
        try {
            ...
            const result = await this._client.sendRequest(EditCreateRowRequest.type, params);
     ...
     */
    public async deleteRow(ownerUri: string, rowId: number): Promise<EditDeleteRowResult> {
        try {
            ...
            const result = await this._client.sendRequest(EditDeleteRowRequest.type, params);
     ...
     */
    public async revertRow(ownerUri: string, rowId: number): Promise<EditRevertRowResult> {
        try {
            ...
            const result = await this._client.sendRequest(EditRevertRowRequest.type, params);
    ...
    public async updateCell(
        ...
        try {
            ...
            const result = await this._client.sendRequest(EditUpdateCellRequest.type, params);
    ...
    public async dispose(ownerUri: string): Promise<EditDisposeResult> {
        try {
            ...
            const result = await this._client.sendRequest(EditDisposeRequest.type, params);
