...
* Enabled Schema Compare launch from external extensions and SQL Projects through a new run command, also used to support the Update Project From Database feature
