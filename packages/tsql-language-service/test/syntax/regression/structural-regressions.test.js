...
`);
    ...
    // ALTER TABLE forms combine attribute toggles and table-level defaults.
...
`);
    ...
    // Expression forms use binary DEFAULTs, money literals, COLLATE, and LEFT/RIGHT.
...
`);
    ...
    // Security statements use column permissions, omitted parts, and multiword classes.
...
`);
    ...
    // Table sources cover omitted components, legacy hints, and grouped joins.
