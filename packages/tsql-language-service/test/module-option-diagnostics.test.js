...
// SqlParser accepts any identifier inside a module WITH clause and then classifies it: an unknown
...
async function analyze(sql, options = {}) {
    ...
    const snapshot = await runtime.open("file:///module-options.sql", 1, sql);
