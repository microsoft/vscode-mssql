...
import type { AnalysisProfile, AnalysisProfileInput } from "../../../src/index.ts";
...
function assertProfileContract(resolve: (profile?: AnalysisProfileInput) => AnalysisProfile): void {
...
suite("T-SQL analysis profile contract", () => {
    ...
    test("pins the resolved profile on the in-process runtime", () => {
        assertProfileContract(
            (profile: AnalysisProfileInput | undefined) =>
