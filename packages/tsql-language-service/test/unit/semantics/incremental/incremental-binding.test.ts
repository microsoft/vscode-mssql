...
import type { SemanticSnapshot, SyntaxSnapshot, TextChange } from "../../../../src/index.ts";
const {
    applyTextChanges,
...
interface IncrementalAnalysis {
    readonly document: InstanceType<typeof ImmutableTextSnapshot>;
    readonly syntaxService: InstanceType<typeof LezerSyntaxService>;
    readonly binder: InstanceType<typeof CatalogSemanticBinder>;
    readonly metadata: InstanceType<typeof InMemoryMetadataProvider>;
    readonly syntax: SyntaxSnapshot;
    readonly semantics: SemanticSnapshot;
}

function analyze(sql: string, metadata = new InMemoryMetadataProvider()): IncrementalAnalysis {
...
function update(analysis: IncrementalAnalysis, change: TextChange): IncrementalAnalysis {
...
function assertEquivalent(actual: SemanticSnapshot, expected: SemanticSnapshot): void {
