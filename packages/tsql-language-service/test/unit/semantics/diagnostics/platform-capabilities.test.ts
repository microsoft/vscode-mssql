...
function provider(environment: Partial<SqlEnvironment> = {}) {
...
async function diagnose(
    ...
    environment: Partial<SqlEnvironment> = {},
...
const managedInstance: TsqlFeatureProfile = {
    ...azure,
    engineProfile: "azure-sql-managed-instance",
};
const synapse = {
...
const unknown = { engineProfile: "unknown", previewFeatures: false } satisfies TsqlFeatureProfile;
...
suite("platform capability semantics", () => {
    ...
    test("reports a cross-database name on Azure SQL Database", async () => {
        ...
        assertDefined(diagnostics[0], "expected a cross-database diagnostic");
