...
export type DiagnosticCategory = "scanner" | "parser" | "binder";
export type DiagnosticRole = "api-precondition" | "message-fragment" | "signature-help-text";
...
export const diagnosticCatalog: readonly DiagnosticCatalogEntry[] = [
    {
