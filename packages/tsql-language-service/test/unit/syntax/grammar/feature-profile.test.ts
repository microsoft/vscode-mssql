...
import type { SyntaxDiagnostic, TsqlFeatureProfile } from "../../../../src/index.ts";
...
function profile(
    ...
    engineProfile: TsqlFeatureProfile["engineProfile"],
): TsqlFeatureProfile {
...
function unavailable(
    sql: string,
    word: string,
    availability: NonNullable<SyntaxDiagnostic["availability"]>,
): SyntaxDiagnostic {
