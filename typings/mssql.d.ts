...
declare module "mssql" {
  ...
  export interface SchemaCompareIncludeExcludeResult
    extends azdata.ResultStatus {
  ...
  export interface ISchemaCompareService {
    ...
    schemaCompareOpenScmp(
      filePath: string,
    ): Thenable<SchemaCompareOpenScmpResult>;
  ...
  export interface SchemaComparePublishProjectResult
    extends azdata.ResultStatus {
    changedFiles: string[];
    addedFiles: string[];
    deletedFiles: string[];
  ...
  export interface GetCrossPlatformCompatibilityResult
    extends azdata.ResultStatus {
    /**
  ...
  export interface ICmsService {
    ...
    createCmsServer(
      ...
      connectiondetails: azdata.ConnectionInfo,
      ownerUri: string,
    ): Thenable<ListRegisteredServersResult>;
  ...
  export interface IObjectManagementService {
    ...
    initializeView(
      ...
      parentUrn: string,
      objectUrn: string,
    ): Thenable<ObjectManagement.ObjectViewInfo<ObjectManagement.SqlObject>>;
    /**
     * Save an object.
    ...
    search(
      ...
      searchText?: string,
      schema?: string,
    ): Thenable<ObjectManagement.SearchResultItem[]>;
    /**
     * Detach a database.
     * @param connectionUri The URI of the server connection.
     * @param database The target database.
    ...
    createCredential(
      connectionUri: string,
      credentialInfo: azdata.CredentialInfo,
    ): Thenable<void>;
    /**
  ...
  export interface IQueryStoreService {
     ...
     */
    getRegressedQueriesSummary(
      connectionOwnerUri: string,
      timeIntervalRecent: TimeInterval,
      timeIntervalHistory: TimeInterval,
     ...
     * @param minNumberOfQueryPlans Minimum number of query plans for a query to included in the report
     */
    getRegressedQueriesDetailedSummary(
      connectionOwnerUri: string,
      timeIntervalRecent: TimeInterval,
      timeIntervalHistory: TimeInterval,
      minExecutionCount: number,
     ...
     * @param minNumberOfQueryPlans Minimum number of query plans for a query to included in the report
     */
    getHighVariationQueriesSummary(
      connectionOwnerUri: string,
     ...
     * @param minNumberOfQueryPlans Minimum number of query plans for a query to included in the report
     */
    getHighVariationQueriesDetailedSummary(
      connectionOwnerUri: string,
      timeInterval: TimeInterval,
      orderByColumnId: string,
      descending: boolean,
     ...
     * @param minNumberOfQueryPlans Minimum number of query plans for a query to included in the report
     */
    getTopResourceConsumersSummary(
      connectionOwnerUri: string,
      timeInterval: TimeInterval,
      orderByColumnId: string,
      descending: boolean,
     ...
     * @param minNumberOfQueryPlans Minimum number of query plans for a query to included in the report
     */
    getTopResourceConsumersDetailedSummary(
      connectionOwnerUri: string,
      timeInterval: TimeInterval,
      orderByColumnId: string,
      descending: boolean,
     ...
     * @param selectedStatistic Statistic to calculate on SelecticMetric
     */
    getPlanSummaryChartView(
      connectionOwnerUri: string,
      queryId: number,
      timeIntervalMode: PlanTimeIntervalMode,
      timeInterval: TimeInterval,
      selectedMetric: Metric,
      selectedStatistic: Statistic,
    ): Promise<QueryStoreQueryResult>;
     ...
     * @param minNumberOfQueryPlans Minimum number of query plans for a query to included in the report
     */
    getOverallResourceConsumptionReport(
      connectionOwnerUri: string,
      specifiedTimeInterval: TimeInterval,
      specifiedBucketInterval: BucketInterval,
      selectedMetric: Metric,
      selectedStatistic: Statistic,
      topQueriesReturned: number,
      returnAllQueries: boolean,
  ...
  export const enum BucketInterval {
    // values from SSMS: $\Sql\ssms\core\QueryStoreModel\Common\BucketInterval.cs
    Minute = 0,
    Hour = 1,
    Day = 2,
    Week = 3,
  ...
  export const enum PlanTimeIntervalMode {
    // values from SSMS: $\Sql\ssms\core\QueryStoreModel\PlanSummary\PlanSummaryConfiguration.cs
    SpecifiedRange = 0,
    AllHistory = 1,
  }

  export const enum Metric {
    // values from SSMS: $\Sql\ssms\core\QueryStoreModel\Common\Metric.cs
    CPUTime = 0,
    Duration = 1,
    LogicalWrites = 2,
    LogicalReads = 3,
  ...
  export const enum Statistic {
    // values from SSMS: $\Sql\ssms\core\QueryStoreModel\Common\Statistic.cs
    Avg = 0,
    Min = 1,
    Max = 2,
    Stdev = 3,
