...
declare module 'vscode-mssql' {
	...
	*/
	...
	export namespace designers {
		 ...
		 */
		export function openTableDesigner(providerId: string, tableInfo: TableInfo, telemetryInfo?: { [key: string]: string }, objectExplorerContext?: ITreeNodeInfo): Thenable<void>;
		 ...
		 */
		export interface DesignerTableProperties extends TableDesignerComponentProperties, DesignerTablePropertiesBase {
			/**
