...
declare module "azdata" {
  ...
  export interface SerializationProvider extends DataProvider {
     ...
     */
    startSerialization(
      requestParams: SerializeDataStartRequestParams,
    ): Thenable<SerializeDataResult>;
    /**
     * Continue the data serialization.
     * @param requestParams the request parameters.
     */
    continueSerialization(
      requestParams: SerializeDataContinueRequestParams,
    ): Thenable<SerializeDataResult>;
  }
  ...
  export namespace dataprotocol {
    ...
    export function registerSqlAssessmentServicesProvider(
      provider: SqlAssessmentServicesProvider,
    ): vscode.Disposable;
    /**
     * Registers a DataGridProvider which is used to provide lists of items to a data grid
     * @param provider The provider implementation
     */
    export function registerDataGridProvider(
  ...
  export namespace diagnostics {
    ...
    export interface ErrorDiagnosticsProvider {
      ...
      handleConnectionError(
        errorInfo: IErrorInformation,
        connection: connection.ConnectionProfile,
      ): Thenable<ConnectionDiagnosticsResult>;
    }
    ...
    export function registerDiagnosticsProvider(
      providerMetadata: ErrorDiagnosticsProviderMetadata,
      errorDiagnostics: ErrorDiagnosticsProvider,
    ): vscode.Disposable;
  }
  ...
  export namespace connection {
     ...
     */
    export function getNonDefaultOptions(
      profile: IConnectionProfile,
    ): Thenable<string>;
  }
  ...
  export namespace workspace {
     ...
     */
    export function createAndEnterWorkspace(
      location: vscode.Uri,
     ...
     * @param workspaceFile
     */
    export function saveAndEnterWorkspace(
      workspaceFile: vscode.Uri,
    ): Promise<void>;
  }
  ...
  export type ExecutionPlanData =
    | executionPlan.ExecutionPlanGraphInfo
    | executionPlan.ExecutionPlanGraph[];

  export interface ExecutionPlanComponentProperties
   ...
   */
  export interface ExecutionPlanComponent
    extends Component,
      ExecutionPlanComponentProperties {}

  export interface ModelBuilder {
    executionPlan(): ComponentBuilder<
  ...
  export namespace dataprotocol {
    export function registerTableDesignerProvider(
      provider: designers.TableDesignerProvider,
    ): vscode.Disposable;
    export function registerExecutionPlanProvider(
      provider: executionPlan.ExecutionPlanProvider,
    ): vscode.Disposable;
    /**
     ...
     */
    export function registerServerContextualizationProvider(
  ...
  export namespace designers {
    ...
    export function openTableDesigner(
      ...
      objectExplorerContext?: ObjectExplorerContext,
    ): Thenable<void>;
  ...
  export namespace contextualization {
    ...
    export interface ServerContextualizationProvider extends DataProvider {
      ...
      getServerContextualization(
        ownerUri: string,
      ): Thenable<GetServerContextualizationResult>;
    }
  }
  ...
  export namespace window {
     ...
     */
    export function openCustomErrorDialog(
     ...
     */
    export function openServerFileBrowserDialog(
      connectionUri: string,
      targetPath: string,
     ...
     */
    export function openBackupUrlBrowserDialog(
      connectionUri: string,
  ...
  export interface ModelBuilder {
    chart<
      ...
      TData extends ChartData<TChartType>,
      TOptions extends ChartOptions<TChartType>,
    >(): ComponentBuilder<
      ChartComponent<TChartType, TData, TOptions>,
      ChartComponentProperties<TChartType, TData, TOptions>
    >;
  }
  ...
  export interface ChartDataSet<TVal extends Chart1DPoint | number>
    extends ChartDataEntryBase {
    data: TVal[];
  }
  ...
  export interface BarChartDataSet
    extends ChartDataSet<Chart1DPoint | number> {}
  ...
  export interface HorizontalBarChartData
    extends ChartData<"horizontalBar">,
      BarChartDataBase {}
  ...
  export interface HorizontalBarChartOptions
    extends ChartOptions<"horizontalBar">,
      BarChartOptionsBase {}
  ...
  export interface ScatterplotOptions
    extends ChartOptions<"scatter">,
      ScatterplotOptionBase {}
