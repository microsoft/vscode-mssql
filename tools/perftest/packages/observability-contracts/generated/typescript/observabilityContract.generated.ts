...
export const OBS_CONTRACT: Registry = {
    ...
    events: [
        ...
        },
        {
            ...
            attrs: {},
            attrsComplete: false,
            notes: "Local SQL container lifecycle spans. Image/container identifiers remain governed diagnostic fields and are never measurement dimensions.",
        },
        {
            name: "queryStudio.dbSwitch",
            kind: "event",
            phase: "instant",
            feature: "queryStudio",
            processRoles: ["extensionHost"],
        ...
        {
            name: "schemaVisualizer.open.retry",
            kind: "event",
            phase: "instant",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
        ...
        {
            name: "schemaVisualizer.getModel.begin",
            kind: "marker",
            phase: "begin",
            pairsWith: "schemaVisualizer.getModel.end",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
        ...
        {
            name: "schemaVisualizer.getModel.end",
            kind: "marker",
            phase: "end",
            pairsWith: "schemaVisualizer.getModel.begin",
            feature: "schemaVisualizer",
            processRoles: ["extensionHost"],
            timingClass: "sameProcessMonotonic",
            measurementEligible: false,
