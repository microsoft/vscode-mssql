...
gulp.task('html:vendor', () => {
  ...
  gulp.src([
    config.paths.html.root + '/node_modules/angular2_slickgrid/components/libs/SlickGrid/lib/jquery-1.7.min.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/components/libs/SlickGrid/lib/jquery.event.drag-2.2.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/components/libs/SlickGrid/lib/jquery-ui-1.8.16.custom.min.js',
    config.paths.html.root + '/node_modules/underscore/underscore-min.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/components/libs/SlickGrid/slick.core.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/components/libs/SlickGrid/slick.grid.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/components/libs/SlickGrid/slick.editors.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/components/libs/SlickGrid/plugins/slick.dragrowselector.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/components/libs/SlickGrid/plugins/slick.autosizecolumn.js',
