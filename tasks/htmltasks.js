...
gulp.task('html:vendor', () => {
  ...
  gulp.src([
    config.paths.html.root + '/node_modules/angular2_slickgrid/libs/SlickGrid/lib/jquery-1.7.min.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/libs/SlickGrid/lib/jquery.event.drag-2.2.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/libs/SlickGrid/lib/jquery-ui-1.8.16.custom.min.js',
    config.paths.html.root + '/node_modules/underscore/underscore-min.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/libs/SlickGrid/slick.core.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/libs/SlickGrid/slick.grid.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/libs/SlickGrid/slick.editors.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/libs/SlickGrid/plugins/slick.dragrowselector.js',
    config.paths.html.root + '/node_modules/angular2_slickgrid/libs/SlickGrid/plugins/slick.autosizecolumn.js',
  ...
  gulp.src([
    ...
    config.paths.html.root + '/node_modules/angular2_slickgrid/components/css/SlickGrid.css',
    config.paths.html.root + '/node_modules/angular2_slickgrid/libs/SlickGrid/slick.grid.css'
  ]).pipe(gulp.dest(config.paths.html.out + '/lib/css'));

  gulp.src([
      config.paths.html.root + '/node_modules/angular2_slickgrid/index.js',
      config.paths.html.root + '/node_modules/angular2_slickgrid/components/**/*.js'
  ], { base: config.paths.html.root + '/node_modules/angular2_slickgrid' }).pipe(gulp.dest(config.paths.html.out + '/lib/js/angular2_slickgrid'))
